...
public class DBConnectionManager {
	...
	private static void init() {
		if (cpds == null) {
			...
			String DATABASE_USER = SystemConfig.getConfigInfomation("SystemConfigResources", "DATABASE_USER"); // 数据库用户名
			String DATABASE_PASSWORD = SystemConfig.getConfigInfomation("SystemConfigResources", "DATABASE_PASSWORD"); // 数据库密码
