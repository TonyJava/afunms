			...
			if (serviceList != null && serviceList.size() > 0) {
				...
				for (int i = 0; i < serviceList.size(); i++) {
					...
					try {
						...
						sql
								.append("insert into nms_sercice_data_temp(nodeid,ip,type,subtype,name,instate,opstate,paused,uninst,collecttime,startMode,pathName,description,serviceType,pid,groupstr)values('");
