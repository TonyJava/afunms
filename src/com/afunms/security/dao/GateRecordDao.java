...
public class GateRecordDao extends BaseDao {
	private static final String globeSql = "select a.*,b.xing_ming from nmj_log a left join human b on a.person_key=b.person_key order by a.logkey desc";
	...
	public List combinQuery(boolean[] itemSwitchs, String startTime, String endTime, String person, String io, String event) {
		...
		int loc = sqlBuf.toString().lastIndexOf(" and ");
		String sql = null;
		if (loc != -1) {
