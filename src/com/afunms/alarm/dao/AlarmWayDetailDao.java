...
public class AlarmWayDetailDao extends BaseDao implements DaoInterface {
	...
	public boolean save(BaseVo vo) {
		...
		sql.append("insert into nms_alarm_way_detail(alarm_way_id,alarm_category,date_type," + "send_times,start_date,end_date,start_time,end_time,user_ids" + ") values('");
		...
		try {
			if (list != null) {
				for (int i = 0; i < list.size(); i++) {
					...
					sql.append("insert into nms_alarm_way_detail(alarm_way_id,alarm_category,date_type," + "send_times,start_date,end_date,start_time,end_time,user_ids"
							+ ") values('");
