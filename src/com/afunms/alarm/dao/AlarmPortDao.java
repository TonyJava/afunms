...
public class AlarmPortDao extends BaseDao implements DaoInterface {
	...
	public boolean save(BaseVo baseVo) {
		...
		sql
				.append("insert into system_portconfig(ipaddress,portindex,name,type,subtype,enabled,levelinvalue1,levelinvalue2,levelinvalue3,leveloutvalue1,leveloutvalue2,leveloutvalue3,smsin1,smsin2,smsin3,smsout1,smsout2,smsout3,alarm_info)values(");
		sql.append("'");
