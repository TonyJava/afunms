...
public class AlarmWayUtil {
	...
	/**
	 * 将告警方式的详细配置存入数据库中 此方法将 alarmWayDetailList 中 alarmWayDetail 的 alarmWayId
	 * 设置好后 先根据 alarmWayId 删除 alarmWayDetail 后调用saveAlarmWayDetail(List
	 * alarmWayDetailList)方法
	 * 
	 * @param alarmWay
