...
public class SerialBean {
	...
	/**
	 * the parameters of this SerialBean. The parameters contains serialPortId ,
	 * baudRate , databits , stopbits , parity.
	 */
	private Parameters parameters;

	/**
	 * Communications port management. This property is for internal properties,
	 * temporary does not provide get () and set () method, if there is a need
	 * to increase
	 */
	 ...
	 * 
	 * @param parameters
	 *            the parameters of this SerialBean. The parameters contains
	 *            serialPortId , baudRate , databits , stopbits , parity.
	 * 
	 */
	 ...
	 * 
	 * @param serialPortId
	 *            ,serialPortId, databits, stopbits, parity
	 * 
	 * 
	 */
	 ...
	 * 
	 * @author nielin create on 2010-01-28
	 * 
	 */
	...
	/**
	 * 
	 * This function initializes the specified serial port and returns the
	 * result to initialize. If the initialization successful return 1,
	 * otherwise returns -1. The result is that the serial port initialization
	 * has been SerialBean exclusive use, If the serial port is successfully
	 * initialized, then open a thread to read incoming data from the serial
	 * port and save it in the buffer.
	 * 
	 * @author nielin create on 2010-01-28
	 * 
	 * @return
	...
	public int initialize() {
		...
		try {
			...
			// parity (For example serialPort.PARITY_NONE --PARITY_NONE ,
	...
	/**
	 * This function is from the serial port (buffer) to read a specified length
	 * of a string. Length parameter specifies the length of the string
	 * returned.
	 * 
	 * @author nielin create on 2010-01-28
	 * 
	...
	/**
	 * 
	 * This function sends a string to the serial port. Msg parameter is the
	 * string that need to be sent.
	 * 
	 * @author nielin create on 2010-01-28
	 * 
	 * @param msg
