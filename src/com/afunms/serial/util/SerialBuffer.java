...
public class SerialBuffer {
	...
	/**
	 * Whether to return data. False is not return data , then go to the thread
	 * to wait.
	 */
	 ...
	 * @param available
	 */
	public SerialBuffer(String currentMsg, String contentMsg, String lastMsg, String tempContentMsg, int lengthNeeded, boolean available) {
	...
	/**
	 * 
	 * This function returns a string with all data from the incomin messages.
	 * 
	 */
	public synchronized String GetMsg() {
		currentMsg = "";
