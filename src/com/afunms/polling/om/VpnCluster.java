...
public class VpnCluster implements Serializable {
	...
	// public VpnCluster(Long id,String ipaddress,String type,String subtype,int
	// clusterVirIndex
	// ,int clusterId,int clusterVirState,String
	// clusterVirIfname,java.lang.String clusterVirAddr
