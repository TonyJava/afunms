...
public class CollectHpStorageData extends SnmpMonitor {
	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {
		...
		try {
			...
			String[] cmds = { "set cli-parameter timeout 90 pager off", "show system", "show controllers", "show disks", "show ports", "show vdisks", "show enclosure-status",
					"show sensor-status", "show volumes" };
