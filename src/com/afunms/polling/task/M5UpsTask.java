									...
									if(returnHash!=null){
										...
										if(inputVector != null || inputVector.size() < 0){
											for(int i = 0 ; i < inputVector.size(); i++){
												SystemCollectEntity collectdata = (SystemCollectEntity)inputVector.get(i); 
												updateData(node, nodeGatherIndicators, collectdata.getThevalue(),collectdata.getSubentity());
											}
										}
									} else {}
									...
									if(returnHash!=null){
										...
										if(bypassVector != null || bypassVector.size() < 0){
											for(int i = 0 ; i < bypassVector.size(); i++){
												SystemCollectEntity collectdata = (SystemCollectEntity)bypassVector.get(i); 
												updateData(node, nodeGatherIndicators, collectdata.getThevalue(),collectdata.getSubentity());
											}
										}
									}
									...
									if(returnHash!=null){
										...
										if(outputVector != null || outputVector.size() < 0){
											for(int i = 0 ; i < outputVector.size(); i++){
												SystemCollectEntity collectdata = (SystemCollectEntity)outputVector.get(i); 
												updateData(node, nodeGatherIndicators, collectdata.getThevalue(),collectdata.getSubentity());
											}
										}
									}
