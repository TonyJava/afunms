...
public class FTPComply {
	...
	public static void main(String[] args) {
		...
		// String download_time = (System.currentTimeMillis()-download_last)+"";
		// //下载时间
		...
		// ft.uploadFile(new File("D:\\logs.tar"), new File("D:\\BC\\logs.tar"),
		// "logs.tar","192.168.1.103",21,"nms","webnms",12000);
