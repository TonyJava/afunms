...
public class AS400Telnet {
	...
	public static void main(String[] args) {
		...
		// TelnetWrapperForAS400 telnetWrapperForAS400 = new
		// TelnetWrapperForAS400();
		// String user = "WUSER";
		// String pwd = "DEMO2PWD";
		...
		// String result3 = new
		// String(telnetWrapperForAS400.write("wrkactjob"));
		// String result4 =
		// telnetWrapperForAS400.send(telnetWrapperForAS400.write((char)12));
	 ...
	 * @param shellPrompt
	 */
	public AS400Telnet(String ip, String username, String password, String loginPrompt, String passwordPrompt, String shellPrompt) {
		this.ip = ip;
	...
	public Vector getHardware() {
		...
		try {
			...
			// if(result.indexOf("More...")!=-1){
			// data = data + str.substring(str.indexOf("Text")+4,
			// str.indexOf("More..."));
			// }
			// if(result.indexOf("Bottom")!=-1){
			// data = data + str.substring(str.indexOf("Text")+4,
	...
	public boolean init(String ip, String username, String password, String loginPrompt, String passwordPrompt, String shellPrompt) {
		this.ip = ip;
		this.username = username;
		this.password = password;
		this.loginPrompt = loginPrompt;
	...
	public Vector parseHardware(String result) {
		...
		// if(result.indexOf("Resource")<0 || result.indexOf("Status")<0 ||
		// result.indexOf("Text")<0 || result.indexOf("Type-model")<0){
		// return vector;
		// }
