...
public class PollMonitorManager extends BaseManager implements ManagerInterface {
	...
	private String refresh() {
		...
		try {
			oids = new String[] { "1.3.6.1.2.1.25.6.3.1.2", // 名称
	...
	private String showdiscardsperc() {
		...
		try {
			...
			p_drawchartMultiLine(bandhashtable2[0], "丢包率",
	...
	private String showerrorsperc() {
		...
		try {
			...
			p_drawchartMultiLine(bandhashtable1[0], "端口错误率", newip
	...
	private String showpacks() {
		...
		try {
			...
			p_drawchartMultiLine(bandhashtable2[0], "收发信息包数",
	...
	private String showinpacks() {
		...
		try {
			...
			p_drawchartMultiLine(bandhashtable2[0], "入口数据包", newip + "ifpacks",
					800, 200, "Packs");
			imgurlhash.put("ifpacks", "resource/image/jfreechart/" + newip
					+ "ifpacks" + ".png");
	...
	private String showoutpacks() {
		...
		try {
			...
			Hashtable[] bandhashtable2 = hostmanager.getIfBand_OutPacks(ip,
					index, banden2, bandch2, starttime1, totime1);
			p_drawchartMultiLine(bandhashtable2[0], "出口数据包", newip + "ifpacks",
					800, 200, "Packs");
			imgurlhash.put("ifpacks", "resource/image/jfreechart/" + newip
					+ "ifpacks" + ".png");
	...
	/**
	 * @author zhubinhua
	 * @return 用createImage()方法生成的图片，来生成word文档，然后提供给客户端下载
	 */
	...
	private void netpingUtil(String timeType) {
		...
		try {
			...
			// 生成Memory图片
			memoryStr = area_chooseDrawLineType(timeType, memoryhash, "内存利用率",
					"内存利用率(%)", 350, 200);
			...
			returnStr1 = area_chooseDrawLineType(timeType, cpuhash, "CPU利用率",
					"CPU利用率(%)", 350, 200);
			...
			try {
				...
				allutilStr = area_chooseDrawMultiLineType(timeType, value,
						"综合流速", bandch3, bandch4, 350, 200, 100000, 100000);
