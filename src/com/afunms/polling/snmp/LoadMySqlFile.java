	...
	public Hashtable getMySqlCongfig() {
		...
		try {
			...
			while (it.hasNext()) {
				...
				// List elements=XPath.selectNodes(root,
				// "//content/variables/column");
