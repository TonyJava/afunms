...
public class StorageCollection {
	 ...
	 * @param password
	 */
	public StorageCollection(String ipaddress, String name, String username, String password) {
	 ...
	 * @param password
	 */
	public void setParameter(String ipaddress, String name, String username, String password) {
		this.ipaddress = ipaddress;
		this.username = username;
		this.password = password;
	}
