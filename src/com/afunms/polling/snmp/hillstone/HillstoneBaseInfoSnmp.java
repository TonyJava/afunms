...
public class HillstoneBaseInfoSnmp extends SnmpMonitor {
	public Hashtable collect_Data(NodeGatherIndicators alarmIndicatorsNode) {
		...
		String[] oids = { ".1.3.6.1.4.1.28557.2.2.7.0",// sysCurSession
		...
		String[] oids_ = { ".1.3.6.1.4.1.28557.2.2.1.7.0",// sysCurSession
		...
		sysCurSessionCollectData.setUnit("¸ö");
		...
		sysTotalSessionCollectData.setUnit("¸ö");
