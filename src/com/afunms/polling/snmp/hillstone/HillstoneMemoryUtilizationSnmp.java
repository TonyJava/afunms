...
public class HillstoneMemoryUtilizationSnmp extends SnmpMonitor {
	public Hashtable collect_Data(NodeGatherIndicators alarmIndicatorsNode) {
		...
		MemoryCollectEntity collectData = new MemoryCollectEntity();
		...
		MemoryCollectEntity curCollectData = new MemoryCollectEntity();
		...
		MemoryCollectEntity totalCollectData = new MemoryCollectEntity();
