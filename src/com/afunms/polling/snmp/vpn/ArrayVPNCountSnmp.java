	...
	public Hashtable collect_Data(NodeGatherIndicators alarmIndicatorsNode) {
		...
		try {
			...
			try {
				...
				String[] oids = new String[] { "1.3.6.1.4.1.7564.31.1.1", "1.3.6.1.4.1.7564.32.1.1", "1.3.6.1.4.1.7564.33.1.1", "1.3.6.1.4.1.7564.35.1.1",
						"1.3.6.1.4.1.7564.36.1.1", "1.3.6.1.4.1.7564.37.1.1", "1.3.6.1.4.1.7564.38.1.1", "1.3.6.1.4.1.7564.39.1.1", "1.3.6.1.4.1.7564.40.1.1",
						"1.3.6.1.4.1.7564.41.1.1", "1.3.6.1.4.1.7564.42.1.1", "1.3.6.1.4.1.7564.43.1.1", "1.3.6.1.4.1.7564.44.1.1" };

				valueArray = SnmpUtils.getTableData(node.getIpAddress(), node.getCommunity(), oids, node.getSnmpversion(), 3, 1000);
				String[] oids1 = new String[] { "1.3.6.1.4.1.7564.18.1.1", "1.3.6.1.4.1.7564.18.1.2", };
				String[][] valueArray1 = SnmpUtils.getTableData(node.getIpAddress(), node.getCommunity(), oids1, node.getSnmpversion(), 3, 1000);
				String[] oids2 = new String[] { "1.3.6.1.4.1.7564.34.1.1.1", "1.3.6.1.4.1.7564.34.1.2.1", };
				String[][] valueArray2 = SnmpUtils.getTableData(node.getIpAddress(), node.getCommunity(), oids2, node.getSnmpversion(), 3, 1000);
				String[] oids3 = new String[] { "1.3.6.1.4.1.7564.23.1", };
