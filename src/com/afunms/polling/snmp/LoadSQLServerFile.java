...
public class LoadSQLServerFile {
	...
	public Hashtable<String, String> getCaches() {
		...
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/caches");
	...
	public Hashtable<String, String> getLocks() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/lock");
			List<Element> children = element.getChildren();
			for (Element child : children) {
				table.put(child.getName(), child.getText());
			}
	...
	public Hashtable<String, String> getMems() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/mems");
			List<Element> children = element.getChildren();
			for (Element child : children) {
				table.put(child.getName(), child.getText());
			}
	...
	public Hashtable<String, String> getPageConn() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/pageConnection");
			List<Element> children = element.getChildren();
			for (Element child : children) {
				table.put(child.getName(), child.getText());
			}
	...
	public Hashtable<String, String> getPages() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/page");
			List<Element> children = element.getChildren();
			for (Element child : children) {
				table.put(child.getName(), child.getText());
			}
	...
	public Hashtable<String, String> getScans() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/scans");
			List<Element> children = element.getChildren();
			for (Element child : children) {
				table.put(child.getName(), child.getText());
			}
	...
	public Vector<Hashtable<String, String>> getSQLProcessesTabInfo() {
		...
		try {
			List list = XPath.selectNodes(root, "//content/sqlserverProcessesTabInfo/row");
	...
	public Hashtable<String, String> getSqls() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/sqls");
			List<Element> children = element.getChildren();
			for (Element child : children) {
				table.put(child.getName(), child.getText());
			}
				...
				if (ele.getChild("dbname") != null) {
					...
					if (dbnames.get(name) == null) {
						...
						if (ele.getChild("usedperc") != null) {
							data.put("usedperc", ele.getChildText("usedperc"));
						}
						if (ele.getChild("usedsize") != null) {
							data.put("usedsize", ele.getChildText("usedsize"));
						}
						names.add(name);
						datas.put(name, data);
						dbnames.put(name, 1);
	...
	public Hashtable<String, String> getSQLServerSysTabInfo() {
		Hashtable<String, String> table = new Hashtable<String, String>();
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/sqlServerSysTabInfo/row");
			...
			table.put("IsIntegratedSecurityOnly", element.getChildText("isIntegratedSecurityOnly"));
	...
	public String getStatus() {
		String str = null;
		try {
			Element element = (Element) XPath.selectSingleNode(root, "//content/status");
			str = element.getText();
		} catch (JDOMException e) {
			e.printStackTrace();
			throw new RuntimeException(e);
