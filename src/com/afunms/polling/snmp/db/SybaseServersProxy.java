...
public class SybaseServersProxy extends SnmpMonitor {
	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {
		...
		if (dbmonitorlist != null) {
			...
			String[] args = new String[] { "server_name", "server_network_name", "server_class", "server_status" };
			...
			if (extent_v != null && extent_v.size() > 0) {
				...
				try {
					...
					String deletesql = "delete from nms_sybaseserversinfo where serverip='" + ip + "'";
					// 加入队列
					...
					for (int k = 0; k < extent_v.size(); k++) {
						...
						String insertsql = "insert into nms_sybaseserversinfo(serverip, server_name, server_network_name, server_class, server_status, mon_time) " + " values ('"
								+ ip + "','" + server_name + "','" + server_network_name + "','" + server_class + "','" + server_status;
