...
public class SybaseDbProxy extends SnmpMonitor {
	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {
		...
		if (dbmonitorlist != null) {
			...
			String[] args = new String[] { "db_name", "db_usedperc", "db_size", "db_freesize" };
			...
			if (extent_v != null && extent_v.size() > 0) {
				...
				try {
					...
					String deletesql = "delete from nms_sybasedbinfo where serverip='" + ip + "'";
					// 加入队列
					...
					for (int k = 0; k < extent_v.size(); k++) {
						...
						String insertsql = "insert into nms_sybasedbinfo(serverip, db_namer, db_usedperc, db_size, db_freesize, mon_time) " + " values ('" + ip + "','" + db_name
								+ "','" + db_usedperc + "','" + db_size + "','" + db_freesize;
