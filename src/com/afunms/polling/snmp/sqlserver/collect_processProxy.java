...
public class collect_processProxy extends SnmpMonitor {
	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {
		...
		String[] args = new String[] { "serverip", "spid", "waittime", "lastwaittype", "waitresource", "dbname", "username", "cpu", "physical_io", "memusage", "login_time",
				"last_batch", "status", "hostname", "program_name", "hostprocess", "cmd", "nt_domain", "nt_username", "net_library", "loginame", "mon_time" };
