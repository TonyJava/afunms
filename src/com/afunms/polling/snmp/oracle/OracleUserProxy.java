...
public class OracleUserProxy extends SnmpMonitor {
	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {
		...
		if (dbmonitorlist != null) {
			...
			htKey = "returnVal1";
			users.put(htKey, LogParser.parse(fileContent, htKey, args).get(htKey));
					...
					try {
						...
						if (returnVal != null && returnVal.size() > 0) {
							for (int i = 0; i < returnVal.size(); i++) {
								...
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("cpu_time")));
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("sorts")));
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("buffer_gets")));
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("runtime_mem")));
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("version_count")));
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("disk_reads")));
								sBuffer.append("','");
						...
						if (returnVal1 != null && returnVal1.size() > 0) {
							for (int i = 0; i < returnVal1.size(); i++) {
								...
								sBuffer.append(serverip);
								sBuffer.append("','");
								sBuffer.append(String.valueOf(returnHash.get("users")));
								sBuffer.append("','");
								sBuffer.append(label);
								if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
									sBuffer.append("','");
