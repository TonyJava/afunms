	...
	public Hashtable collect_Data(NodeGatherIndicators nodeGatherIndicators) {
		...
		if (dbmonitorlist != null) {
			...
			try {
				...
				util = new OracleJdbcUtil(dburl, dbmonitorlist.getUser(), EncryptUtil.decode(dbmonitorlist.getPassword()));
				util.jdbc();
			...
			if (gahash != null && !gahash.isEmpty()) {
				...
				try {
					...
					String default_2k_buffer_cache = String.valueOf(gahash.get("DEFAULT_2K_buffer_cache"));
					String max_processes_count = String.valueOf(gahash.get("max_processes_count"));
					String total_pga_allocated = String.valueOf(gahash.get("total_PGA_allocated"));
					String default_4k_buffer_cache = String.valueOf(gahash.get("DEFAULT_4K_buffer_cache"));
					String shared_pool = String.valueOf(gahash.get("shared_pool"));
					String default_32k_buffer_cache = String.valueOf(gahash.get("DEFAULT_32K_buffer_cache"));
					String default_buffer_cache = String.valueOf(gahash.get("DEFAULT_buffer_cache"));
					String large_pool = String.valueOf(gahash.get("large_pool"));
					String aggregate_pga_target_parameter = String.valueOf(gahash.get("aggregate_PGA_target_parameter"));
					String default_16k_buffer_cache = String.valueOf(gahash.get("DEFAULT_16K_buffer_cache"));
					String global_memory_bound = String.valueOf(gahash.get("global_memory_bound"));
					String default_8k_buffer_cache = String.valueOf(gahash.get("DEFAULT_8K_buffer_cache"));
					String extra_bytes_read_written = String.valueOf(gahash.get("extra_bytes_read/written"));
					String pga_memory_freed_back_to_os = String.valueOf(gahash.get("PGA_memory_freed_back_to_OS"));
					String total_freeable_pga_memory = String.valueOf(gahash.get("total_freeable_PGA_memory"));
					String recompute_count_total = String.valueOf(gahash.get("recompute_count_(total)"));
					String maximum_pga_used_for_auto_workareas = String.valueOf(gahash.get("maximum_PGA_used_for_auto_workareas"));
