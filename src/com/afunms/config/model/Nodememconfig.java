...
public class Nodememconfig extends BaseVo implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((totalVirtualMemorySize == null) ? 0 : totalVirtualMemorySize.hashCode());
		result = prime * result + ((totalVisibleMemorySize == null) ? 0 : totalVisibleMemorySize.hashCode());
		return result;
	}
	...
	/**
	 * @param totalVirtualMemorySize
	 *            the totalVirtualMemorySize to set
	 */
	...
	/**
	 * @param totalVisibleMemorySize
	 *            the totalVisibleMemorySize to set
	 */
