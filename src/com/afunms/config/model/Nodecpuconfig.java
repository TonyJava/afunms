...
public class Nodecpuconfig extends BaseVo implements Serializable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((dataWidth == null) ? 0 : dataWidth.hashCode());
		result = prime * result + ((l2CacheSize == null) ? 0 : l2CacheSize.hashCode());
		result = prime * result + ((l2CacheSpeed == null) ? 0 : l2CacheSpeed.hashCode());
		result = prime * result + ((name == null) ? 0 : name.hashCode());
		result = prime * result + nodeid;
		result = prime * result + ((processorId == null) ? 0 : processorId.hashCode());
		result = prime * result + ((descrOfProcessors == null) ? 0 : descrOfProcessors.hashCode());
		return result;
	}
