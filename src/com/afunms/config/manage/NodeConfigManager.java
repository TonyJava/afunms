...
public class NodeConfigManager extends BaseManager implements ManagerInterface {
	...
	private String readyEdit() {
		...
		try {
			...
			OctetString targetAddress = new OctetString("10.10.1.1");// remote
		...
		try {
			...
			Integer32 sourceFileType = new Integer32(4);// 3:startupConfig
			// 4:runningConfig
			...
			Integer32 destFileType = new Integer32(1);// 3:startupConfig
			// 4:runningConfig
			...
			// 1:waiting 2:running 3:successful (done, entry no longer write
			// protected)
		...
		CommonUtil.demoChangeStringToHex("192.168.1.202");
