...
public class SyslogFinals {
	...
	static {
		...
		// 一条条件中的关键字是否有序，0：无序 sql如message like '%xxx%' and message like
		// '%yyy%'，1：有序 sql如message like '%xxx%yyy%',性能问题
		...
		// 密码修改成功的用户 id 628
		// LEN-D3117189Administrator: 设置了用户帐户密码: 目标帐户名: zhangyashe 目标域:
		// LEN-D3117189 目标帐户 ID:
		// %{S-1-5-21-1891745410-3080488357-2315099178-1004} 呼叫方用户名:
		// Administrator 呼叫方所属域: LEN-D3117189 呼叫方登录 ID: (0x0,0x214F6)
		...
		// 0B03哪些账号被删除/禁用？629
		// LEN-D3117189Administrator: 停用了用户帐户: 目标帐户名: zhangyashe 目标域:
		// LEN-D3117189 目标帐户 ID:
		// %{S-1-5-21-1891745410-3080488357-2315099178-1004} 呼叫方用户名:
		// Administrator 呼叫方所属域: LEN-D3117189 呼叫方登录 ID: (0x0,0x2211B)
		...
		// qsLoginFailureList.add(new ArrayList(Arrays.asList(2, 0, "登录失败:
		// 原因:","用户名:","登录类型: 3")));
		...
		// qsLoginFailureList.add(new ArrayList(Arrays.asList(3, 0, "failed to
		// login")));
