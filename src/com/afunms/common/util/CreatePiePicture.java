...
public class CreatePiePicture {
	 ...
	 */
	public String createOneRingChart(double[] data1, String[] labels, int[] colors, TitleModel tm) {
		...
		TextBox t = c.addText(tm.getX5(), tm.getX6(), tm.getTopTitle(), "宋体", 12, 0x000000);
		t.setBackground(tm.getBgcolor(), Chart.Transparent, Chart.softLighting());
		t.setRoundedCorners(5);
		c.addLegend(tm.getX7(), tm.getX8(), false, "宋体", 9).setBackground(Chart.Transparent, Chart.Transparent);
	 ...
	 * 
	 */
	public String createPieChartWithLegend(String[] labels, int[] colors, double[] data, TitleModel tm) {
		Chart.setLicenseCode(CommonMethod.keycode);
	 ...
	 */
	public String createTwoConcentricDonutChart(double[] data1, String title1, double[] data2, String title2, String[] labels, int[] colors, TitleModel tm) {
		Chart.setLicenseCode(CommonMethod.keycode);
		PieChart c = new PieChart(tm.getXpic(), tm.getYpic());
		c.addTitle(tm.getTopTitle(), "宋体", 18);
		c.setDonutSize(tm.getX1(), tm.getX2(), tm.getX3(), tm.getX4());
		TextBox t = c.addText(tm.getX5(), tm.getX6(), title1, "宋体", 8, 0xffffff);
		t.setBackground(0x008800, Chart.Transparent, Chart.softLighting());
		t.setRoundedCorners(5);
		c.addLegend(tm.getX7(), tm.getX8(), false, "宋体", 8).setBackground(Chart.Transparent, Chart.Transparent);
		c.setData(data1, labels);
		c.setColors2(Chart.DataColor, colors);
		c.setLineColor(0xffffff);
		c.setLabelFormat("{percent|0}%");
		...
		TextBox t2 = c2.addText(tm.getR2textx(), tm.getR2texty(), title2, "宋体", 8, 0xffffff, Chart.Center);
		...
		c2.setLabelPos(-25);
		c2.set3D();
		c.makeChart3().merge(c2.makeChart3(), tm.getInr2x(), tm.getInr2y(), Chart.TopLeft, 0);
		String picname = tm.getPicName() + ".png";
		String str = CommonMethod.checkFile() + "/" + picname;
		c.makeChart(str);
		return picname;
