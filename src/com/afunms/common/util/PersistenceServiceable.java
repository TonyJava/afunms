...
public interface PersistenceServiceable {
	...
	public void addOneApplicInfor(String applicName, String nodeId, String applicType, String applicIpAddress, String appliNetMask, String loginUser, String loginPassword,
	...
	// List中为AlarmInfor
	public List searchAlarmItem(String alarmId, Connection outConnection);
