...
public class PortScanConfig {
	...
	/**
	 * 对此ip地址的端口扫描的状态 现在分三种： "0" 为 未进行扫描 "1" 为 扫描完成 "2" 为 扫描正在继续
	 */
	 ...
	 * @param status
	 */
	public PortScanConfig(String id, String ipaddress, List isScannedList, List unScannedList, String timeout, int total, String status) {
		this.id = id;
