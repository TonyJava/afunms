...
public class SystemInfoService {
	...
	public String getSupperInfo(String supperId) {
		...
		try {
			...
			if (supper != null) {
				...
				suppername = "<a href=\"#\"  style=\"cursor:hand\" onclick=\"window.showModalDialog('/afunms/supper.do?action=read&id=" + supper.getSu_id()
						+ "',window,',dialogHeight:400px;dialogWidth:600px')\">" + suppername + "</a>";
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public Vector<SystemCollectEntity> getSystemInfo() {
