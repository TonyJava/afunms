...
import com.afunms.inform.model.Performance;
...
public class PerformanceDao extends BaseDao {
	...
	public List getNetworkCpuTopN(String beginDate) {
		String sql = "select a.ip_address,a.id,b.node_id,ROUND(avg(b.value),1) value from " + "topo_host_node a,topo_node_single_data b where substring(b.log_time,1,10)='"
	...
	public List getNetworkTrafficTopN(String day) {
		String sql = "select a.ip_address,a.id,b.node_id,ROUND(avg(b.percentage),1) value " + "from topo_host_node a,topo_interface_data b where substring(b.log_time,1,10)='"
				+ day + "' and (b.moid='003002' or b.moid='003003') and a.id=b.node_id " + " and a.category <4 group by b.node_id order by value desc";
		return getTopN(sql);
	}
	...
	public List getServerCpuTopN(String day) {
		String sql = "select a.ip_address,a.id,b.node_id,ROUND(avg(b.percentage),1) value from " + "topo_host_node a,topo_node_multi_data b where substring(b.log_time,1,10)='"
	...
	public List getServerMemoryTopN(String day) {
		String sql = "select a.ip_address,a.id,b.node_id,ROUND(avg(b.value),1) value from " + "topo_host_node a,topo_node_single_data b where substring(b.log_time,1,10)='" + day
				+ "' and b.moid='001002' and a.id=b.node_id group by b.node_id order by value desc";
		return getTopN(sql);
	}
