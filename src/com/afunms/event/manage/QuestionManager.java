...
public class QuestionManager {
	...
	private String systemQuestion(String questionID, String starttime, String totime) {
	...
	private String userManagerQuestion(String questionID, String starttime, String totime) {
		...
		if ("0B01".equalsIgnoreCase(questionID)) {// 哪些用户成功修改了他们的密码？
			...
			map = getUserCount(starttime, totime, SyslogFinals.getMsgClause(SyslogFinals.QSUSERCHANGEPASSSUCCESS));
			...
			map = getUserCount(starttime, totime, SyslogFinals.getMsgClause(SyslogFinals.QSUSERACCOUNTDISABLED));
			...
			map = getUserCount(starttime, totime, SyslogFinals.getMsgClause(SyslogFinals.QSUSERMODIFYLOG));
...
/**
 * String[] c1 =
 * {"0A01哪些机器的登录失败次数最多？","0A02哪些用户账号被滥用事件比较多？","0A03网络中发生了多少登录失败的事件？"}; String[]
 * c2 =
 * {"0B01哪些用户成功修改了他们的密码？","0B02哪些用户修改密码失败？","0B03哪些账号被删除/禁用？","0B04哪些用户修改或者清除了安全审计日志？"};
 * String[] c3 =
 * {"0C01哪些机器生成了大量的事件？","0C02哪些程序生成了警报事件？","0C03哪些机器生成了大量的危急事件？","0C04哪些进程生成了多少个危急事件？"};
 * String[] c4 = {"0D01最近一周的告警事件有哪些？", "0D02最近一小时出现了多少错误事件？"}; String[] c5 =
 * {"0E01哪些主机生成的告警最多？"}; String[] c6 =
 * {"0F01服务器或工作站上多少用户修改了系统时间？","0F02新添的主机中有多少个危急事件？","0F03新添的主机中有多少次对象和文件夹被访问？"};
 */
