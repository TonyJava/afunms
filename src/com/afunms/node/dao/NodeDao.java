...
public class NodeDao extends BaseDao implements DaoInterface {
	 ...
	 * save:
	 * <p>
	 * 保存 {@link BaseVo} 至数据库(未实现)
	 * 
	 * @param vo -
	 *            {@link BaseVo}
	 * @return {@link Boolean} - 如果保存成功，则返回 <code>true</code> ，否则返回
	 *         <code>false</code>
	 * 
	 * @since v1.01
	 ...
	 * update:
	 * <p>
	 * 修改 {@link BaseVo} 至数据库(未实现)
	 * 
	 * @param vo -
	 *            {@link BaseVo}
	 * @return {@link Boolean} - 如果修改成功，则返回 <code>true</code> ，否则返回
	 *         <code>false</code>
	 * 
	 * @since v1.01
	 ...
	 * @param list -
	 *            表
	 * @return {@link Boolean} - 如果创建成功则返回 <code>true</code> ，否则返回
	 *         <code>false</code>
	 * 
	 * @since v1.01
	 */
