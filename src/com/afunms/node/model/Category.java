...
public class Category extends BaseVo implements Serializable {
	 ...
	 * 是否为叶节点
	 * 
	 * @return boolean - 如果为叶节点则返回 <code>true</code> ，否者返回 <code>false</code>
	 * @since v1.01
	 */
