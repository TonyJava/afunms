...
public class IpMacBaseDao extends BaseDao implements DaoInterface {
	...
	public boolean update(BaseVo baseVo) {
		IpMacBase vo = (IpMacBase) baseVo;
		String sql = "update nms_ipmacbase set ifband=" + vo.getIfband() + ",ifemail='" + vo.getIfemail() + "',iftel='" + vo.getIftel() + "',ifsms='" + vo.getIfsms()
				+ "',employee_id=" + vo.getEmployee_id() + " where id=" + vo.getId();
		return saveOrUpdate(sql);
	}
