	...
	public String createGallery(List<String> list, int index, int buttonStyle) {
		...
		if (list != null) {
			...
			for (int i = 0; i < list.size(); ++i) {
				...
				selectGradeOne = selectGradeOne + "<option value=\"" + resTypeName + "\">" + resTypeName + "</option>";
			}
		...
		String html = "<tr><td nowrap align=\"right\" height=\"24\" width=\"20%\">图元类型&nbsp;</td>" + "<td nowrap width=\"80%\">" + selectGradeOne
				+ "</td></tr><tr><td colspan=\"2\"><table width=\"100%\"><tr>" + "<td align=\"center\" width=\"20%\" id=\"galleryPanel\">" + galleryPanel
				+ "</td></tr></table></td></tr>" + "<br><table width=\"200\" align=\"center\"><tr><td align=\"center\">" + buttonPanel + "</td>" + "</tr></table>";
	...
	public String createGallery(List<String> list) {
		...
		if (list != null) {
			...
			for (int i = 0; i < list.size(); ++i) {
				...
				selectGradeOne = selectGradeOne + "<option value=\"" + category + "\">" + cn_name + "</option>";
			}
		...
		String html = "<tr><td  nowrap align=\"right\" height=\"24\" width=\"20%\">图元类型&nbsp;" + "</td><td align=\"left\" style=\"padding-left:0px;\">" + selectGradeOne
				+ "</td></tr><tr><td colspan=\"2\"><table width=\"100%\"><tr>" + "<td align=\"center\" width=\"20%\" id=\"galleryPanel\">" + galleryPanel
				+ "</td></tr></table></td></tr>" + "<br><table width=\"200\" align=\"center\"><tr><td align=\"center\">" + buttonPanel + "</td>" + "</tr></table>";
	...
	public String getGalleryPanel(List<HintItem> list) {
		...
		try {
			for (int j = 0; j < list.size(); ++j) {
				...
				galleryPanel = galleryPanel + "<img width=32 height=32 onClick=\"changeStyle(this.id)\" id=\"" + path + "\" src=\"" + path + "\"  alt=\"" + type
						+ "\"/>&nbsp;&nbsp;";
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public String getEquipGalleryPanel(List<EquipImage> list) {
		...
		try {
			for (int j = 0; j < list.size(); ++j) {
				...
				galleryPanel = galleryPanel + "<img width=32 height=32 onClick=\"changeStyle(this.id)\" id=\"" + id + "\" src=\"" + path + "\"  alt=\"" + type + "\"/>&nbsp;&nbsp;";
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
