...
public class NetDistrictIpDetail extends BaseVo {
	 ...
	 * @param isOnline
	 */
	public NetDistrictIpDetail(int id, String districtId, String ipDistrictId, String districtName, String netDistrictName, String ipTotal, String ipaddress, String isUsed,
			String isOnline) {
		this.id = id;
