...
public class IpDistrictDetail extends BaseVo {
	 ...
	 * @param unOnlineToatl
	 */
	public IpDistrictDetail(int id, String district, String ipTotal, String usedTotal, String unusedTotal, String isOnlineTotal, String unOnlineToatl) {
		this.id = id;
