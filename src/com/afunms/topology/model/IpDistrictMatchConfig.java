...
public class IpDistrictMatchConfig extends BaseVo {
	 ...
	 * @param date
	 */
	public IpDistrictMatchConfig(int id, String relateipaddr, String nodeIp, String nodeName, String isOnline, String originalDistrict, String currentDistrict, String isMatch,
			String time) {
		this.id = id;
