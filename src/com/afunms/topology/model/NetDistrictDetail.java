...
public class NetDistrictDetail extends BaseVo {
	 ...
	 */
	public NetDistrictDetail(int id, String districtId, String ipDistrictId, String districtName, String netDistrictName, String ipTotal, String usedTotal, String unusedTotal,
			String isOnlineTotal, String unOnlineToatal) {
		this.id = id;
