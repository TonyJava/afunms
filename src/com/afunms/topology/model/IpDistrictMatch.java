...
public class IpDistrictMatch extends BaseVo {
	 ...
	 * @param isMatch
	 */
	public IpDistrictMatch(int id, String relateipaddr, String nodeIp, String nodeName, boolean isOnline, String originalDistrict, String currentDistrict, boolean isMatch) {
		this.id = id;
