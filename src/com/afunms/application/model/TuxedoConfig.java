...
public class TuxedoConfig extends BaseVo {
	 ...
	 * @param reservation3
	 */
	public TuxedoConfig(int id, String name, String ipAddress, String community, String port, String status, String mon_flag, String bid, String sendmobiles, String sendemail,
			String sendphone, String reservation1, String reservation2, String reservation3) {
		this.id = id;
		this.name = name;
