...
public class Storage extends BaseVo {
	 ...
	 * @param sendphone
	 */
	public Storage(int id, String ipaddress, String name, String username, String password, String status, String mon_flag, String collecttype, String company, String type,
			String serialNumber, String bid, String collectTime, String supperid, String sendemail, String sendmobiles, String sendphone) {
		this.id = id;
