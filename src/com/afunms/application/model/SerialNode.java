...
/**
 * 
 * This class is a serial device node of the model class, its corresponding data
 * table name is system_serial_node
 * 
 * @author nielin create at 2010-01-28</br>
 * 
 */
public class SerialNode extends BaseVo {
	...
	/**
	 * the number of data bit( it must be for the following data : 5 , 6 , 7 or
	 * 8)
	 * 
	...
	/**
	 * the number of Parity (it must be for the following data : 0 , 1 , 2 , 3
	 * or 4)
	 * 
