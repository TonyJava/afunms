...
public class WeblogicJdbc {
	...
	String jdbcLeaked = null;// 泄漏数
	String jdbcWaitMaxTime = null;// 最长等待时间
	String jdbcWaitCurrent = null;// 等待数
	...
	public void setJdbcConnectionPoolRuntimeActiveConnectionsCurrentCount(String jdbcConnectionPoolRuntimeActiveConnectionsCurrentCount) {
	...
	public void setJdbcConnectionPoolRuntimeVersionJDBCDriver(String jdbcConnectionPoolRuntimeVersionJDBCDriver) {
	...
	public void setJdbcConnectionPoolRuntimeMaxCapacity(String jdbcConnectionPoolRuntimeMaxCapacity) {
	...
	public void setJdbcConnectionPoolRuntimeActiveConnectionsAverageCount(String jdbcConnectionPoolRuntimeActiveConnectionsAverageCount) {
	...
	public void setJdbcConnectionPoolRuntimeHighestNumAvailable(String jdbcConnectionPoolRuntimeHighestNumAvailable) {
