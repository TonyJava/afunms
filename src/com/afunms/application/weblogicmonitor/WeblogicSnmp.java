...
public class WeblogicSnmp extends AbstractSnmp {
	...
	public List collectNormalData() {
		...
		try {
			try {
				String[] oids = new String[] { ".1.3.6.1.4.1.140.625.530.1.15", // 活动域名
	...
	public List collectJobData() {
		...
		try {
			try {
				String[] oids = new String[] { ".1.3.6.1.4.1.140.625.1250.1.1", //
	...
	public List collectServletData() {
		...
		try {
			try {
				...
				// //servletRuntimeServletClassName
				};
				this.setVariableBindings(oids);
				List list = this.table(this.getDefault_community(), nethost);
				for (int i = 0; i < list.size(); i++) {
	...
	public List collectLogData() {
		...
		try {
			try {
				String[] oids = new String[] { ".1.3.6.1.4.1.140.625.700.1.15", //
	...
	public List collectWebLogData() {
		...
		try {
			try {
				String[] oids = new String[] { ".1.3.6.1.4.1.140.625.1160.1.18", ".1.3.6.1.4.1.140.625.1160.1.13", ".1.3.6.1.4.1.140.625.1160.1.14" };
				this.setVariableBindings(oids);
				List list = this.table(this.getDefault_community(), nethost);
				for (int i = 0; i < list.size(); i++) {
	...
	public List collectQueueData() {
		...
		String[] oids = new String[] { ".1.3.6.1.4.1.140.625.180.1.15", ".1.3.6.1.4.1.140.625.180.1.25", ".1.3.6.1.4.1.140.625.180.1.30", ".1.3.6.1.4.1.140.625.180.1.35",
	...
	public List collectJdbcData() {
		...
		String[] oids = new String[] { ".1.3.6.1.4.1.140.625.190.1.15", // 名称
	...
	public List collectWebAppData() {
		...
		String[] oids = new String[] { ".1.3.6.1.4.1.140.625.430.1.15", // 名称
	...
	public List collectHeapData() {
		...
		String[] oids = new String[] { ".1.3.6.1.4.1.140.625.340.1.15", // 名称
	...
	public List collectServerData() {
		...
		String[] oids = new String[] { ".1.3.6.1.4.1.140.625.360.1.15", // 服务名
