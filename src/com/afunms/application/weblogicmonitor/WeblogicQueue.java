...
public class WeblogicQueue {
	...
	String threadPoolRuntimeExecuteThreadIdleCount = null; // 执行线程当前空闲数
															// .1.3.6.1.4.1.140.625.180.1.25
	String executeQueueRuntimePendingRequestOldestTime = null; // 队列中最长等待请求的存在时间
	...
	public void setThreadPoolRuntimeExecuteThreadIdleCount(String threadPoolRuntimeExecuteThreadIdleCount) {
	...
	public void setExecuteQueueRuntimePendingRequestOldestTime(String executeQueueRuntimePendingRequestOldestTime) {
	...
	public void setExecuteQueueRuntimePendingRequestCurrentCount(String executeQueueRuntimePendingRequestCurrentCount) {
	...
	public void setExecuteQueueRuntimePendingRequestTotalCount(String executeQueueRuntimePendingRequestTotalCount) {
