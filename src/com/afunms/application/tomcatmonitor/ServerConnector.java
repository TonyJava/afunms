...
public class ServerConnector {
	private static Logger logger = Logger.getLogger(ServerConnector.class);
	...
	public HTTPResponse getConnect(String ip, int port, String target, String realm, String user, String password, boolean isAuth) {
