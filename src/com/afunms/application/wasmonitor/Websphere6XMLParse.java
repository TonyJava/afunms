...
public class Websphere6XMLParse {
	...
	public Hashtable getSystemDataConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_systemData = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_SYSTEM6 + "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='"
				+ serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_SYSTEM6 + "']/CountStatistic/self::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName
				+ "']/Server[@name='" + serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_SYSTEM6 + "']/AverageStatistic/self::*";
		;
	...
	public Hashtable getTranscationConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_transcation = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_TRANSCATION6 + "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='"
				+ serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_TRANSCATION6 + "']/CountStatistic/self::*";
	...
	public Hashtable getThreadConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_thread = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_THREADPOOL6 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='"
				+ serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_THREADPOOL6 + "']/Stat/self::*";
	...
	public Hashtable getServletConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_servlet = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_SERVLET6 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_SERVLET6 + "']/Stat/self::*";
	...
	public Hashtable getJDBCConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_jdbc = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_JDBC6 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_JDBC6 + "']/Stat/self::*";
	...
	public Hashtable getJVMConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpathJVM = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'" + WebsphereConstants.WEBSPHERE_JVM6
				+ "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name='"
				+ WebsphereConstants.WEBSPHERE_JVM6 + "']/CountStatistic/self::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_JVM6 + "']/BoundedRangeStatistic/self::*";
