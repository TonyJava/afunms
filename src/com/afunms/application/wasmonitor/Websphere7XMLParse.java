...
public class Websphere7XMLParse {
	...
	public void getCacheConfAndPerf(Node listServer, String nodeName, String serverName, String version) {
		String xpathCache = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_CACHE6 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_CACHE6 + "']/Stat/self::*";
	...
	public Hashtable getExtensionConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		...
		String xpath_Extension = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_REGISTRY_CACHE6 + "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName
				+ "']/Server[@name='" + serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_REGISTRY_CACHE6 + "']/CountStatistic/self::*" + "|/PerformanceMonitor/"
				+ "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_REGISTRY_CACHE6
				+ "']/DoubleStatistic/self::*";
	...
	public Hashtable getSystemDataConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_systemData = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_SYSTEM7 + "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='"
				+ serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_SYSTEM7 + "']/CountStatistic/self::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName
				+ "']/Server[@name='" + serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_SYSTEM7 + "']/AverageStatistic/self::*";
		;
		...
		if (null != listSystems && listSystems.size() > 0) {
			...
			for (Node systemNode : listSystems) {
				...
				if (WebsphereConstants.SYSTEM_CPUUSAGESINCELAST.equalsIgnoreCase(systemNodeName)) {
					...
					if (cpuUsageSinceLastMeasurement < 0)
						cpuUsageSinceLastMeasurement = 0;
					...
					if (cpuUsageSinceServerStarted < 0)
						cpuUsageSinceServerStarted = 0;
	...
	public Hashtable getTranscationConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_transcation = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_TRANSCATION7 + "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='"
				+ serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_TRANSCATION7 + "']/CountStatistic/self::*";
	...
	public Hashtable getThreadConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_thread = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_THREADPOOL7 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='"
				+ serverName + "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_THREADPOOL7 + "']/Stat/self::*";
	...
	public Hashtable getServletConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_servlet = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_SERVLET7 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_SERVLET7 + "']/Stat/self::*";
	...
	public Hashtable getJDBCConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpath_jdbc = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'"
				+ WebsphereConstants.WEBSPHERE_JDBC7 + "']/Stat/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_JDBC7 + "']/Stat/self::*";
	...
	public Hashtable getJVMConfAndPerf(String ip, Node listServer, String nodeName, String serverName, String version) {
		String xpathJVM = "/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name=" + "'" + WebsphereConstants.WEBSPHERE_JVM7
				+ "']/CountStatistic/following-sibling::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName + "']/Stat/Stat[@name='"
				+ WebsphereConstants.WEBSPHERE_JVM7 + "']/CountStatistic/self::*" + "|/PerformanceMonitor/" + "Node[@name='" + nodeName + "']/Server[@name='" + serverName
				+ "']/Stat/Stat[@name='" + WebsphereConstants.WEBSPHERE_JVM7 + "']/BoundedRangeStatistic/self::*";
