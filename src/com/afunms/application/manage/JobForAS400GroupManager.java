...
public class JobForAS400GroupManager extends BaseManager implements ManagerInterface {
	...
	// List<BaseVo> list = nodeUtil.getNodeByTyeAndSubtype(Constant.TYPE_HOST,
	// Constant.TYPE_HOST_SUBTYPE_WINDOWS);
	...
	// if(processgroupname!=null && !"null".equals(processgroupname) &&
	// processgroupname.length()>0){
