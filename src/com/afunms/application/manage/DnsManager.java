...
public class DnsManager extends BaseManager implements ManagerInterface {
	...
	private String add() {
		...
		try {
			...
			ctable.createTable("dnsping", allipstr, "dnsping");// Ping
			ctable.createTable("dnspingh", allipstr, "dnspingh");// Ping
			ctable.createTable("dnspingd", allipstr, "dnspingd");// Ping
	...
	public String delete() {
		...
		try {
			// conn = new DBManager();
			ctable.deleteTable("dnsping", allipstr, "dnsping");// Ping
			ctable.deleteTable("dnspingh", allipstr, "dnspingh");// Ping
			ctable.deleteTable("dnspingd", allipstr, "dnspingd");// Ping
		} catch (Exception e) {
