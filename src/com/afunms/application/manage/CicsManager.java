...
public class CicsManager extends BaseManager implements ManagerInterface {
	...
	private String add() {
		...
		vo.setId(KeyGenerator.getInstance().getHostKey());// snow add at
															// 2010-05-20
	...
	private String detail() {
		...
		return "/application/cics/detail.jsp?serverName=" + server + "&urlStr=" + urlStr + "&Port=" + Port;
	...
	private String displayData() {
		...
		if ("".equals(transactionId)) {
			...
			String displayText = cicsHelp.displayData(urlStr, server, transactionId);
			System.out.println(displayText);
			request.setAttribute("displayInfo", displayText);
		}
