				...
				if (isShowTreeNodeFlag) {
					...
					if ("1".equals(currTreeNode.getIsHaveChild())) {
						...
						L3: for (Object nodeDTOObject : nodeDTOList) {
							...
							if (Constant.TYPE_GATEWAY.equals(nodeDTO.getType()) || Constant.TYPE_F5.equals(nodeDTO.getType()) || Constant.TYPE_VPN.equals(nodeDTO.getType())
									|| Constant.TYPE_HOST.equals(nodeDTO.getType()) || Constant.TYPE_NET.equals(nodeDTO.getType())
									|| Constant.TYPE_FIREWALL.equals(nodeDTO.getType()) || Constant.TYPE_DB.equals(nodeDTO.getType())
									|| Constant.TYPE_MIDDLEWARE.equals(nodeDTO.getType())) {
