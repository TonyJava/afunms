...
public class PerformancePanelAjaxManager extends AjaxBaseManager implements AjaxManagerInterface {
	...
	public void wulijiAjax() {
		...
		if (flag.equals("1")) {
			...
			sb.append("<tr><td align=>&nbsp;&nbsp;&nbsp;</td><td align=left>CPU利用率" + df.format(Long.parseLong((String) l.get(0)) / 100)
					+ "%</td><td align=left height=29>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cpu(MHz)使用情况：" + l.get(5) + "</td></tr>");
			sb.append("<tr><td height=48 width=30%></td><td height=48 width=30%></td><td height=48 width=30%></td></tr>");
			sb.append("<tr><td align=right>内存(MBps)换入/换出速率：" + l.get(4) + "/" + l.get(3) + "</td> <td align=center>" + ip + "</td><td align=left height=29>内存(虚拟增长)MB:" + l.get(2)
					+ "</td></tr>");
			sb.append("<tr><td height=50 width=30%></td><td height=50 width=30%></td><td height=50 width=30%></td></tr>");
			sb.append("<tr><td align=center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;内存使用情况：" + df.format(Long.parseLong((String) l.get(6)) / 100)
					+ "%</td><td align=right>磁盘(KBPs)使用</td><td align=left height=29>情况:" + l.get(7) + "</td></tr></table></div></td></tr>");
			...
			sb
					.append("<td width='10%' align='center'>序号</td><td width='30%' align='center'>名称</td><td width='20%' align='center'>cpu利用率</td><td width='20%' align='center'>内存利用率</td><td width='20%' align='center'>电源</td>");
			if (vm_list != null && vm_list.size() > 0) {
				...
				for (int i = 0; i < vm_list.size(); i++) {
					...
					if (powerstate.equalsIgnoreCase("poweredOn")) {
						state = "通电";
					} else if (powerstate.equalsIgnoreCase("poweredOff")) {
						state = "未通电";
					} else if (powerstate.equalsIgnoreCase("suspended")) {
						state = "挂起";
					}
					sb.append("<tr align='center' height=28>");
					sb.append("<td width='10%' align='center'>" + (i + 1) + "</td><td width='30%' align='center'><a href = '#'  onclick=\"show_vm('" + vo.get("vid") + "','"
							+ host.getIpAddress() + "','" + vo.get("name") + "')\">" + vo.get("name") + "</a></td><td width='20%' align='center'>"
							+ df.format(Long.parseLong((String) ((ArrayList) l_vmware.get(i)).get(0)) / 100) + "%</td><td width='20%' align='center'>"
							+ df.format(Long.parseLong((String) ((ArrayList) l_vmware.get(i)).get(6)) / 100) + "%</td><td width='20%' align='center'>" + state + "</td>");
					sb.append("<tr align='center' height=28>");
				}
			}
		...
		// 存储
			...
			if (l.size() == 3) {
				...
				sb.append("<tr><td align=>&nbsp;&nbsp;&nbsp;</td><td align=center></td><td align=left height=35 width=55%>已分配:&nbsp;&nbsp;"
						+ df.format(Double.parseDouble((String) l.get(1)) / (1024 * 1024)) + "GB</td></tr>");
				sb.append("<tr><td height=28 width=30%></td><td height=28 width=15%></td><td height=28 width=55%></td></tr>");
				sb.append("<tr><td align=right></td> <td align=center></td><td align=left height=35 width=55%>已使用:&nbsp;&nbsp;"
						+ df.format(Double.parseDouble((String) l.get(0)) / (1024 * 1024)) + "GB</td></tr>");
				sb.append("<tr><td height=25 width=30% align=center valign=top>" + ip + "</td><td height=25 width=15%></td><td height=25 width=55%></td></tr>");
				sb.append("<tr><td height=35 width=30%></td><td height=35 width=15% align=center></td><td height=35 width=55% align=left>容&nbsp;&nbsp;&nbsp;量:&nbsp;&nbsp;"
						+ df.format(Double.parseDouble((String) l.get(2)) / (1024 * 1024)) + "GB</td></tr>");
				sb.append("<tr><td height=25 width=30%></td><td height=25 width=15%></td><td height=25 width=55%></td></tr>");
				sb.append("<tr><td height=35 width=30%></td><td height=35 width=15% align=center valign=top></td><td height=35 width=55% align=left >利用率:&nbsp;&nbsp;"
						+ df.format(Long.parseLong((String) l.get(0)) * 100 / Long.parseLong((String) l.get(2))) + "%</td></tr>");
				sb
						.append("<tr><td align=center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td align=right</td><td align=left height=29></td></tr></table></div></td></tr>");
			} else {
				sb.append("<table  class=detail-data-body><tr><td>");
				sb.append("<div style='background:url(/afunms/img/datastorebg.png);background-repeat: no-repeat;align=center;width:680;height=280;'>");
		...
		// 群集
			...
			if (l_cr.size() == 4) {
				...
				if (!value0.equals("null"))
					value0 = formcat.format(Float.parseFloat(value0) / 1024f);
				if (!avgcpuvalue.equals("null"))
					avgcpuvalue = formcat.format(Float.parseFloat(avgcpuvalue) / 1024f);
				if (!maxcpuvalue.equals("null"))
					maxcpuvalue = formcat.format(Float.parseFloat(maxcpuvalue) / 1024f);

				if (!value1.equals("null"))
					value1 = formcat.format(Float.parseFloat(value1) / 1024f);
				if (!avgcputotal.equals("null"))
					avgcputotal = formcat.format(Float.parseFloat(avgcputotal) / 1024f);
				if (!maxcputotal.equals("null"))
					maxcputotal = formcat.format(Float.parseFloat(maxcputotal) / 1024f);

				if (!value2.equals("null"))
					value2 = formcat.format(Float.parseFloat(value2) / 1024f);
				if (!avgmem2.equals("null"))
					avgmem2 = formcat.format(Float.parseFloat(avgmem2) / 1024f);
				if (!maxmem2.equals("null"))
					maxmem2 = formcat.format(Float.parseFloat(maxmem2) / 1024f);

				if (!value3.equals("null"))
					value3 = formcat.format(Float.parseFloat(value3) / 1024f);

				if (!avgmemtotal3.equals("null"))
					avgmemtotal3 = formcat.format(Float.parseFloat(avgmemtotal3) / 1024f);
				if (!maxmemtotal3.equals("null"))
					maxmemtotal3 = formcat.format(Float.parseFloat(maxmemtotal3) / 1024f);
				sb.append("<table  class=detail-data-body><tr><td>");
				...
				sb.append("<table  border=0><tr><td height=35 ></td><td height=35  align=right></td><td height=35 align=left>" + ip
						+ "</td><td height=35 ></td><td height=35 ></td><td height=35 ></td><td height=35 ></td></tr>");
				sb.append("<tr><td align=>&nbsp;&nbsp;&nbsp;</td><td align=left></td><td align=left height=29></td></tr>");
				sb
						.append("<tr><td height=20 ></td><td height=20  valign=bottom></td><td height=20 valign=bottom>当前(GHz)</td><td height=20  valign=bottom>平均(GHz)</td><td height=20  valign=bottom>最大(GHz)</td><td height=20  valign=bottom></td><td height=20 ></td></tr>");
				sb.append("<tr><td height=20 width=42%></td><td height=20  valign=bottom>使用:</td><td  >" + value0 + "</td><td  >" + avgcpuvalue + "</td><td  >" + maxcpuvalue
						+ "</td><td   align=left><img src=\"/afunms/resource/image/a_xn.gif\" onclick='showcpu(\"" + host.getIpAddress() + "\",\"" + select
						+ "\")' width=15 ></td><td  ></td></tr>");
				sb.append("<tr><td align=right></td> <td align=left>总计:</td><td  >" + value1 + "</td><td  >" + avgcputotal + "</td><td  >" + maxcputotal
						+ "</td><td  align=left><img src=\"/afunms/resource/image/a_xn.gif\" onclick='showcpuuse(\"" + host.getIpAddress() + "\",\"" + select
						+ "\")' width=15 ></td><td align=left height=35></td></tr>");
				sb.append("<tr><td align=>&nbsp;&nbsp;&nbsp;</td><td align=left></td><td align=left height=30></td></tr>");
				sb
						.append("<tr><td height=20 width=42%></td><td height=20  valign=bottom width=7%></td><td height=20 width=10% valign=bottom>当前(GB)</td><td height=20 width=10% valign=bottom>平均(GB)</td><td height=20 width=9% valign=bottom>最大(GB)</td><td height=20 width=9% valign=bottom></td><td height=20 width=13%></td></tr>");
				sb.append("<tr><td height=20 ></td><td height=20  valign=bottom>已消耗:</td><td  >" + value2 + "</td><td  >" + avgmem2 + "</td><td >" + maxmem2
						+ "</td><td height=20  algin=left><img src=\"/afunms/resource/image/a_xn.gif\" onclick='showmem(\"" + host.getIpAddress() + "\",\"" + select
						+ "\")' width=15 ></td><td  ></td></tr>");
				sb.append("<tr><td align=center></td><td align=left >总计:</td><td  >" + value3 + "</td><td  >" + avgmemtotal3 + "</td><td >" + maxmemtotal3
						+ "</td><td  ><img src=\"/afunms/resource/image/a_xn.gif\" onclick='showmemuse(\"" + host.getIpAddress() + "\",\"" + select
						+ "\")' width=15 ></td><td align=left height=35></td></tr></table></div></td></tr>");
			} else {
				sb.append("<table  class=detail-data-body><tr><td>");
				sb.append("<div style='background:url(/afunms/img/cluster.png);background-repeat: no-repeat;align=center;width:660;height=300;background-position:50% 50%'>");
				sb.append("<table  border=0><tr><td height=35 ></td><td height=35  align=right></td><td height=35 align=left>" + ip
				...
				sb
						.append("<tr><td align=center></td><td align=left >总计:</td><td  >0</td><td  >0</td><td >0</td><td  ></td><td align=left height=35></td></tr></table></div></td></tr>");
			}
		}
		// 数据中心
		...
		// 资源池
			...
			if (l.size() == 1) {
				...
				sb
						.append("<table  border=0><tr><td height=25 ></td><td height=25 ></td><td height=25 ></td><td height=25 ></td><td height=25 ></td><td height=25 ></td><td height=25 ></td></tr>");
				sb.append("<tr><td align=></td><td align=right></td><td height=25 >" + ip
						+ "</td><td height=25 ></td><td height=25 ></td><td height=25 ></td><td align=left height=40></td></tr>");
				sb
						.append("<tr valign=bottom><td height=55 width=40%></td><td height=55 width=5%></td><td height=55 width=10%>当前(GHz)</td><td height=55 width=10%>平均(GHz)</td><td height=55 width=10%>最大(GHz)</td><td height=55 width=10% ></td><td height=55 width=15%></td></tr>");
				sb.append("<tr><td align=right></td> <td align=right>使用:</td><td height=25 align=center>" + value0 + "</td><td height=25 align=center>" + value1
						+ "</td><td height=25 align=center>" + value2 + "</td><td height=25 ><img src=\"/afunms/resource/image/a_xn.gif\" onclick='showcpuRP(\""
						+ host.getIpAddress() + "\",\"" + select + "\")' width=15 ></td><td align=left height=35></td></tr>");
				...
				sb
						.append("<tr valign=bottom><td height=55 width=40%></td><td height=55 width=5%></td><td height=55 width=10%>当前(GHz)</td><td height=55 width=10%>平均(GHz)</td><td height=55 width=10%>最大(GHz)</td><td height=55 width=10% ></td><td height=55 width=15%></td></tr>");
				sb
						.append("<tr><td align=right></td> <td align=right>使用:</td><td height=25 align=center>0</td><td height=25 align=center>0</td><td height=25 align=center>0</td><td height=25 ></td><td align=left height=35></td></tr>");
				sb.append("<tr><td height=50 ></td><td height=50 ></td><td height=50></td></tr>");
				sb.append("<tr><td align=center></td><td align=right></td><td align=left height=29></td></tr></table></div></td></tr>");
			}
		}
	...
	public void synchronization() {
		...
		try {
			...
			if (!(ShareData.getSharedata().containsKey(host.getIpAddress()))) {
				if (ipAllData == null)
					ipAllData = new Hashtable();
				if (summaryresultMap != null && summaryresultMap.size() > 0)
					ipAllData.put("summaryresultMap", summaryresultMap);
				ShareData.getSharedata().put(host.getIpAddress(), ipAllData);
			} else {
				if (summaryresultMap != null && summaryresultMap.size() > 0)
					((Hashtable) ShareData.getSharedata().get(host.getIpAddress())).put("summaryresultMap", summaryresultMap);
			}
			if (ipAllData != null) {
				String ip = ipaddress.replace(".", "_");
				List flag_vid = new ArrayList();
				VMWareVidDao viddao = new VMWareVidDao();
				flag_vid = viddao.queryVid(host.getId() + "");// 查出flag=0 
	...
	public void perList() {
		...
		if (flag.equals("physical")) {
			...
			sb.append("<th width='5%'  align='center'>&nbsp;序号</th>" + "<th width='10%' align='center'>&nbsp;CPU利用率</th>" + "<th width='20%' align='center'>内存(虚拟增长)MB</th>"
					+ "<th width='20%' align='center'>&nbsp;内存(MBps)换入/换出</th>" + "<th width='15%' align='center'>&nbsp;CPU(MHz)使用</th>"
					+ "<th width='10%' align='center'>&nbsp;内存使用</th>" + "<th width='15%' align='center'>&nbsp;磁盘(KBps)使用</th></tr>");
			try {
				if (wu_list != null && wu_list.size() > 0) {
					HashMap<String, Object> wuliji = (HashMap<String, Object>) ((HashMap<String, Object>) vmData.get("wuliji")).get("wuliji_per");
					for (int i = 0; i < wu_list.size(); i++) {
						...
						sb.append("<th width='10%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='10%' align=center>&nbsp;"
								+ (df.format(Long.parseLong((String) l.get(0)) / 100) + "%") + "</th>" + "<th width='15%' align=center>&nbsp;" + l.get(2) + "</th>"
								+ "<th width='20%' align=center>&nbsp;" + (l.get(4) + "/" + l.get(3)) + "</th>" + "<th width='15%' align=center>&nbsp;" + (l.get(5)) + "</th>"
		...
		if (flag.equalsIgnoreCase("yun")) {
			...
			sb.append("<table cellspacing='0' cellpadding='0' width='width:680' bgcolor='#FFFFFF' border=1  class='detail-data-body'>");
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='10%'  align='center'>&nbsp;序号</th>" + "<th width='20%' align='center'>&nbsp;名称</th>" + "<th width='15%' align='center'>&nbsp;cpu使用(GHz)</th>"
					+ "<th width='20%' align='center'>&nbsp;cpu总计(GHz)</th>" + "<th width='15%' align='center'>&nbsp;内存已消耗(GB)</th>"
			...
			if (vm_list != null && vm_list.size() > 0) {
				...
				try {
					for (int i = 0; i < vm_list.size(); i++) {
						...
						sb.append("<tr align='center' height=28 class='microsoftLook'>");
						sb.append("<th width='10%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='20%' align=center>&nbsp;" + name + "</th>"
								+ "<th width='15%' align=center>&nbsp;" + value0 + "</th>" + "<th width='20%' align=center>&nbsp;" + value1 + "</th>"
								+ "<th width='15%' align=center>&nbsp;" + value3 + "</th>" + "<th width='20%' align=center>&nbsp;" + value2 + "</th></tr>");
					}
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		// 存储
			...
			sb.append("<table cellspacing='0' cellpadding='0' width='width:680' bgcolor='#FFFFFF' border=1  class='detail-data-body'>");
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='10%'  align=center>&nbsp;序号</th>" + "<th width='20%' align=center>&nbsp;名称</th>" + "<th width='15%' align=center>&nbsp;已分配</th>"
					+ "<th width='20%' align=center>&nbsp;已使用</th>" + "<th width='20%' align=center>&nbsp;容量</th>" + "<th width='15%' align=center>&nbsp;利用率</th></tr>");
				...
				for (int i = 0; i < vm_list.size(); i++) {
					...
					try {
						...
						sb.append("<th width='10%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='20%' align=center>&nbsp;" + name + "</th>"
								...
								+ "<th width='15%' align=center>&nbsp;" + (df.format(Long.parseLong((String) l.get(0)) * 100 / Long.parseLong((String) l.get(2))) + "%")
								+ "</th></tr>");
					} catch (Exception e) {
			...
			sb.append("<table cellspacing='0' cellpadding='0' width='width:680' bgcolor='#FFFFFF' border=1  class='detail-data-body'>");
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='10%'  align='center'>&nbsp;序号</th>" + "<th width=40%' align='center'>&nbsp;名称</th>" + "<th width='50%' align=center>&nbsp;cpu使用(GHz)</th></tr>");
				...
				for (int i = 0; i < vm_list.size(); i++) {
					...
					try {
						...
						if (!value.equals("null"))
							value = formcat.format(Float.parseFloat(value) / 1024f);
					} catch (Exception e) {
					}
					name = dao.queryName(tmp, vm_list.get(i).toString());
					sb.append("<tr align='center' height=28 class='microsoftLook'>");
					sb.append("<th width='10%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='40%' align=center>&nbsp;" + name + "</th>"
	...
	public void emcLunCon() {
		...
		if (ipAllData == null) {
			...
			if (sys_vo != null) {
				...
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getName() + "</td>");
				sb.append("<td align='right' height='24' width='15%'>Raid类型:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getRAIDType() + "</td>");
				sb.append("</tr>");
				sb.append("<tr style='background-color: #ECECEC;'>");
				sb.append("<td align='right' height='24' width='15%'>所属的Raid组ID:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getRAIDGroupID() + "</td>");
				sb.append("<td align='right' height='24' width='15%'>容量:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getLUNCapacity() + "</td>");
				sb.append("</tr>");
				sb.append("</tr>");
				sb.append("<tr >");
				sb.append("<td align='right' height='24' width='15%'>当前所有者:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getCurrentOwner() + "</td>");
				sb.append("<td align='right' height='24' width='15%'>默认所有者:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getDefaultOwner() + "</td>");
				sb.append("</tr>");
				sb.append("</tr>");
				sb.append("<tr style='background-color: #ECECEC;'>");
				sb.append("<td align='right' height='24' width='15%'>写缓存:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getWritecache() + "</td>");
				sb.append("<td align='right' height='24' width='15%'>读缓存:&nbsp;</td>	");
				sb.append("<td width='25%'>&nbsp;" + sys_vo.getReadcache() + "</td>");
				sb.append("</tr>");
				...
				sb.append("</td>");
				sb.append("<td align='right' height='24' width='15%'>绑定磁盘百分比:&nbsp;</td>	");
				...
				if (sys_vo.getDisklistStr() != null && sys_vo.getDisklistStr().length() > 0) {
					...
					for (int i = 0; i < disklistStr.length; i++) {
						if (i == 0) {
							sb.append("<tr style='background-color: #ECECEC;'><td align='right' height='24' width='15%'>&nbsp;&nbsp;&nbsp;磁盘列表:&nbsp;</td>	");
							sb.append("<td width='85%' colspan=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
							sb.append(disklistStr[i]);
						} else if (i % 2 == 1) {
							sb.append("<tr><td align='right' height='20' width='15%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>	");
							sb.append("<td width='85%' colspan=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
							sb.append(disklistStr[i]);
						} else {
							sb
					...
					sb.append("<tr><td align='right' height='24' width='15%'>&nbsp;&nbsp;磁盘列表:&nbsp;</td>	");
					sb.append("<td width='85%' colspan=3>&nbsp;");
				}
				sb.append("</td></tr>");
				sb.append("</table></td>");
				...
				sb.append("<tr style='background-color: #ECECEC;' >");
				sb.append("<td align='right' height='24' width='15%'>磁盘列表:&nbsp;</td>	");
				sb.append("<td width='85%' colspan=3>&nbsp;");
				sb.append("</tr></table></td></tr></table>");
			}
		} else {
	...
	public void emcEnvironment() {
		...
		if (flag.equals("array")) {
			...
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='10%'  align='center'>&nbsp;序号</th>" + "<th width='30%' align='center'>&nbsp;状态</th>" + "<th width='30%' align='center'>&nbsp;当前功率(瓦特)</th>"
					+ "<th width='30%' align='center'>&nbsp;平均功率(瓦特)</th></tr>");

			if (ay != null) {

				sb.append("<tr align='center' height=28 class='microsoftLook'>");
				sb.append("<th width='10%'  align=center>&nbsp;" + 1 + "</th>" + "<th width='30%' align=center>&nbsp;" + ay.getStatus() + "</th>"
						+ "<th width='30%' align=center>&nbsp;" + ay.getPresentWatts()
						+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='arrayenvwt()'  ></th>" + "<th width='30%' align=center>&nbsp;"
						+ ay.getAveragewatts() + "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='arrayenvavgwt()'  ></th></tr>");
			}
			sb.append("</table>");
		}
		...
		if (flag.equalsIgnoreCase("memtmp")) {
			sb.append("<table cellspacing='0' cellpadding='0' width='width:680' bgcolor='#FFFFFF' border=1  class='detail-data-body'>");
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='5%'  align='center'>&nbsp;序号</th>" + "<th width='30%' align='center'>&nbsp;名称</th>" + "<th width='15%' align='center'>&nbsp;状态</th>"
					+ "<th width='25%' align='center'>&nbsp;当前温度(C)</th>" + "<th width='25%' align='center'>&nbsp;平均温度(C)</th></tr>");
			...
			if (list_mem.size() > 0 && list_mem != null) {
				...
				for (int i = 0; i < list_mem.size(); i++) {
					vo = list_mem.get(i);
					sb.append("<tr align='center' height=28 class='microsoftLook'>");
					sb.append("<th width='5%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='30%' align=center>&nbsp;" + vo.getName() + "</th>"
							+ "<th width='15%' align=center>&nbsp;" + vo.getAirStatus() + "</th>" + "<th width='25%' align=center>&nbsp;" + vo.getPresentDegree()
							+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='envtmp(\"" + vo.getName() + "\")'  ></th>"
							+ "<th width='25%' align=center>&nbsp;" + vo.getAverageDegree()
							+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='envavgtmp(\"" + vo.getName() + "\")'  ></th></tr>");
				}
			}
			sb.append("</table>");
		}
		if (flag.equalsIgnoreCase("memory")) {
			...
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='5%'  align='center'>&nbsp;序号</th>" + "<th width='30%' align='center'>&nbsp;名称</th>" + "<th width='15%' align='center'>&nbsp;状态</th>"
					+ "<th width='25%' align='center'>&nbsp;当前功率(瓦特)</th>" + "<th width='25%' align='center'>&nbsp;平均功率(瓦特)</th></tr>");
			...
			if (list_mem.size() > 0 && list_mem != null) {
				...
				for (int i = 0; i < list_mem.size(); i++) {
					...
					sb.append("<tr align='center' height=28 class='microsoftLook'>");
					sb.append("<th width='5%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='30%' align=center>&nbsp;" + vo.getName() + "</th>"
							+ "<th width='15%' align=center>&nbsp;" + vo.getPowerStatus() + "</th>" + "<th width='25%' align=center>&nbsp;" + vo.getPresentWatts()
							+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='memenvwt(\"" + vo.getName() + "\")'  ></th>"
							+ "<th width='25%' align=center>&nbsp;" + vo.getAverageWatts()
							+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='memenvavgwt(\"" + vo.getName() + "\")'  ></th></tr>");
				}
			}
			sb.append("</table>");
		}
			...
			sb.append("<tr align='center' height=28 class='microsoftLook0'>");
			sb.append("<th width='5%'  align=center>&nbsp;序号</th>" + "<th width='30%' align=center>&nbsp;名称</th>" + "<th width='15%' align=center>&nbsp;状态</th>"
					+ "<th width='25%' align=center>&nbsp;当前输出功率(瓦特)</th>" + "<th width='25%' align=center>&nbsp;平均输出功率(瓦特)</th></tr>");
			...
			if (list_power.size() > 0 && list_power != null) {
				...
				for (int i = 0; i < list_power.size(); i++) {
					...
					sb.append("<th width='5%'  align=center>&nbsp;" + (i + 1) + "</th>" + "<th width='30%' align=center>&nbsp;" + vo.getName() + "</th>"
							+ "<th width='15%' align=center>&nbsp;" + vo.getPowerStatus() + "</th>" + "<th width='25%' align=center>&nbsp;" + vo.getPresentWatts()
							+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='bakenvwt(\"" + vo.getName() + "\")'  ></th>"
							+ "<th width='25%' align=center>&nbsp;" + vo.getAverageWatts()
							+ "&nbsp;&nbsp;&nbsp;<img src=\"/afunms/resource/image/a_xn.gif\" onclick='bakenvavgwt(\"" + vo.getName() + "\")'  ></th></tr>");
				}
			}
			sb.append("</table>");
