...
public class Urlmonitor_historyDao extends BaseDao implements DaoInterface {
	...
	public Vector getByUrlid(Integer urlid, String starttime, String totime, int flag) throws Exception {
		...
		try {
			...
			String sql = "";
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = "select a.is_canconnected,a.is_valid,a.is_refresh," + "a.reason,a.mon_time,a.condelay,a.key_exist,a.pagesize,a.change_rate from nms_web_history a where "
						+ "a.url_id=" + urlid + " and (a.mon_time >= '" + starttime + "' and  a.mon_time <= '" + totime + "')  order by a.mon_time";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = "select a.is_canconnected,a.is_valid,a.is_refresh," + "a.reason,a.mon_time,a.condelay,a.key_exist,a.pagesize,a.change_rate from nms_web_history a where "
						+ "a.url_id=" + urlid + " and (a.mon_time >= " + "to_date('" + starttime + "','YYYY-MM-DD HH24:MI:SS')" + " and  a.mon_time <= " + "to_date('" + totime
						+ "','YYYY-MM-DD HH24:MI:SS')" + ")  order by a.mon_time";
			}
	...
	public Hashtable getPingDataById(Integer ftp_id, String starttime, String endtime) {
		...
		if (!starttime.equals("") && !endtime.equals("")) {
			...
			String sql = "";
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = "select a.is_canconnected,a.reason,a.mon_time,a.condelay,a.pagesize,a.change_rate from nms_web_history a where " + "a.url_id=" + ftp_id
						+ " and (a.mon_time >= '" + starttime + "' and  a.mon_time <= '" + endtime + "') order by id";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = "select a.is_canconnected,a.reason,a.mon_time,a.condelay,a.pagesize,a.change_rate from nms_web_history a where " + "a.url_id=" + ftp_id
						+ " and (a.mon_time >= " + "to_date('" + starttime + "','YYYY-MM-DD HH24:MI:SS')" + " and  a.mon_time <= " + "to_date('" + endtime
	...
	public Hashtable getPingData(Integer url_id, String starttime, String endtime, String type) {
		...
		if (!starttime.equals("") && !endtime.equals("")) {
			...
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				...
				sql = "select a.is_canconnected,a.is_valid,a.is_refresh," + "a.reason,a.mon_time,a.condelay,a.key_exist,a.pagesize,a.change_rate from nms_web_history a where "
						+ "a.url_id=" + url_id + " and (a.mon_time >= " + "to_date('" + starttime + "','YYYY-MM-DD HH24:MI:SS')" + " and  a.mon_time <= " + "to_date('" + endtime
