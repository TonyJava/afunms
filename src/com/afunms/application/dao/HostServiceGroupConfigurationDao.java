...
public class HostServiceGroupConfigurationDao extends BaseDao implements DaoInterface {
	...
	public List getHostServiceGroupConfigurationByGroupId(String groupId) {
		...
		try {
			String sql = "select * from nms_host_service_group_config where group_id='" + groupId + "'";
	...
	public boolean saveHostServiceGroupConfigurationList(String gourpId, List hostServiceGroupConfigurationList) {
		try {
			...
			while (iterator.hasNext()) {
				HostServiceGroupConfiguration HostServiceGroupConfiguration = (HostServiceGroupConfiguration) iterator.next();
				sql = "insert into nms_host_service_group_config(group_id,name,status) values ('" + gourpId + "','" + HostServiceGroupConfiguration.getName() + "','"
