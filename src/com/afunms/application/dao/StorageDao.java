...
public class StorageDao extends BaseDao implements DaoInterface {
	...
	public boolean save(BaseVo vo) {
		...
		sql
				.append("insert into nms_storage(id,ipaddress,name,username,password,status,mon_flag,collecttype,company,type,serial_number,bid,collecttime,supperid,sendemail,sendmobiles,sendphone)values('");
