...
public class DBDao extends BaseDao implements DaoInterface {
		...
		try {
			...
			if (!vo.getIpAddress().equals(pvo.getIpAddress())) {
				...
				if (typevo.getDbtype().equalsIgnoreCase("sqlserver")) {
					conn = new DBManager();
					ctable.deleteTable("sqlping", allipstr, "sqlping");// Ping
					conn = new DBManager();
					ctable.deleteTable("sqlpinghour", allipstr, "sqlpinghour");// Ping
					conn = new DBManager();
					ctable.deleteTable("sqlpingday", allipstr, "sqlpingday");// Ping

				} else if (typevo.getDbtype().equalsIgnoreCase("oracle")) {
					conn = new DBManager();
					ctable.deleteTable("oraping", allipstr, "oraping");// Ping
					conn = new DBManager();
					ctable.deleteTable("orapinghour", allipstr, "orapinghour");// Ping
					conn = new DBManager();
					ctable.deleteTable("orapingday", allipstr, "orapingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("db2")) {
					conn = new DBManager();
					ctable.deleteTable("db2ping", allipstr, "db2ping");// Ping
					conn = new DBManager();
					ctable.deleteTable("db2pinghour", allipstr, "db2pinghour");// Ping
					conn = new DBManager();
					ctable.deleteTable("db2pingday", allipstr, "db2pingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("sysbase")) {
					conn = new DBManager();
					ctable.deleteTable("sysping", allipstr, "sysping");// Ping
					conn = new DBManager();
					ctable.deleteTable("syspinghour", allipstr, "syspinghour");// Ping
					conn = new DBManager();
					ctable.deleteTable("syspingday", allipstr, "syspingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("mysql")) {
					conn = new DBManager();
					ctable.deleteTable("myping", allipstr, "myping");// Ping
					conn = new DBManager();
					ctable.deleteTable("mypinghour", allipstr, "mypinghour");// Ping
					conn = new DBManager();
					ctable.deleteTable("mypingday", allipstr, "mypingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("informix")) {
					conn = new DBManager();
					ctable.deleteTable("informixping", allipstr, "informixping");// Ping
					conn = new DBManager();
					ctable.deleteTable("informixpinghour", allipstr, "informixpinghour");// Ping
					conn = new DBManager();
					ctable.deleteTable("informixpingday", allipstr, "informixpingday");// Ping
					ctable.deleteTable("informixlog", allipstr, "informixlog");// 日志信息
				}

				ctable = new CreateTableManager();
				if (typevo.getDbtype().equalsIgnoreCase("sqlserver")) {
					conn = new DBManager();
					ctable.createTable("sqlping", allipstr, "sqlping");// Ping
					conn = new DBManager();
					ctable.createTable("sqlpinghour", allipstr, "sqlpinghour");// Ping
					conn = new DBManager();
					ctable.createTable("sqlpingday", allipstr, "sqlpingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("oracle")) {
					conn = new DBManager();
					ctable.createTable("oraping", allipstr, "oraping");// Ping
					conn = new DBManager();
					ctable.createTable("orapinghour", allipstr, "orapinghour");// Ping
					conn = new DBManager();
					ctable.createTable("orapingday", allipstr, "orapingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("db2")) {
					conn = new DBManager();
					ctable.createTable("db2ping", allipstr, "db2ping");// Ping
					conn = new DBManager();
					ctable.createTable("db2pinghour", allipstr, "db2pinghour");// Ping
					conn = new DBManager();
					ctable.createTable("db2pingday", allipstr, "db2pingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("sybase")) {
					conn = new DBManager();
					ctable.createTable("sysping", allipstr, "sysping");// Ping
					conn = new DBManager();
					ctable.createTable("syspinghour", allipstr, "syspinghour");// Ping
					conn = new DBManager();
					ctable.createTable("syspingday", allipstr, "syspingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("mysql")) {
					conn = new DBManager();
					ctable.createTable("myping", allipstr, "myping");// Ping
					conn = new DBManager();
					ctable.createTable("mypinghour", allipstr, "mypinghour");// Ping
					conn = new DBManager();
					ctable.createTable("mypingday", allipstr, "mypingday");// Ping
				} else if (typevo.getDbtype().equalsIgnoreCase("informix")) {
					conn = new DBManager();
					ctable.createTable("informixping", allipstr, "informixping");// Ping
					conn = new DBManager();
					ctable.createTable("informixpinghour", allipstr, "informixpinghour");// Ping
					conn = new DBManager();
					ctable.createTable("informixpingday", allipstr, "informixpingday");// Ping
					conn = new DBManager();
					ctable.createInformixLogTable(conn, "informixlog", allipstr, "informixlog");// 存放日志信息
				}
			}
		} catch (Exception e) {
			flag = false;
	...
	public boolean save(BaseVo baseVo) {
		...
		DBVo vo = (DBVo) baseVo;
		StringBuffer sql = new StringBuffer();
		sql.append("insert into app_db_node(id,alias,ip_address,ip_long,port,users,password,category,db_name,dbuse,sendmobiles,sendemail,sendphone,bid,managed,dbtype,collecttype,supperid)values(");
		sql.append(vo.getId());
		sql.append(",'");
		sql.append(vo.getAlias());
		sql.append("','");
			...
			if (typevo.getDbtype().equalsIgnoreCase("sqlserver")) {
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("sqlping", vo.getId() + "", "sqlping");// Ping
						ctable.createTable("sqlpinghour", vo.getId() + "", "sqlpinghour");// Ping小时数据
						ctable.createTable("sqlpingday", vo.getId() + "", "sqlpingday");// Ping天数据
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("sqlping", vo.getId() + "", "sqlping");// Ping
						ctable.createSeq(conn, "sqlping", vo.getId() + "");// 生成序列
						ctable.createTriger(conn, "sqlping", vo.getId() + "", "sqlping");// 生成触发器
						ctable.createTable("sqlpinghour", vo.getId() + "", "sqlpinghour");// Ping
						ctable.createSeq(conn, "sqlpinghour", vo.getId() + "");// 生成序列
						ctable.createTriger(conn, "sqlpinghour", vo.getId() + "", "sqlpinghour");// 生成触发器
						ctable.createTable("sqlpingday", vo.getId() + "", "sqlpingday");// Ping
						ctable.createSeq(conn, "sqlpingday", vo.getId() + "");// 生成序列
						ctable.createTriger(conn, "sqlpingday", vo.getId() + "", "sqlpingday");// 生成触发器
					}
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("oraping", vo.getId() + "", "oraping");// Ping
						ctable.createTable("orapinghour", vo.getId() + "", "orapinghour");// Ping
						ctable.createTable("orapingday", vo.getId() + "", "orapingday");// Ping
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("oraping", vo.getId() + "", "oraping");// Ping
						ctable.createTable("orapinghour", vo.getId() + "", "orapinghour");// Ping
						ctable.createTable("orapingday", vo.getId() + "", "orapingday");// Ping
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("db2ping", vo.getId() + "", "db2ping");// Ping
						ctable.createTable("db2pinghour", vo.getId() + "", "db2pinghour");// Ping
						ctable.createTable("db2pingday", vo.getId() + "", "db2pingday");// Ping
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("db2ping", vo.getId() + "", "db2ping");// Ping
						ctable.createTable("db2pinghour", vo.getId() + "", "db2pinghour");// Ping
						ctable.createTable("db2pingday", vo.getId() + "", "db2pingday");// Ping
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("sysping", vo.getId() + "", "sysping");// Ping
						ctable.createTable("syspinghour", vo.getId() + "", "syspinghour");// Ping
						ctable.createTable("syspingday", vo.getId() + "", "syspingday");// Ping
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("sysping", vo.getId() + "", "sysping");// Ping
						ctable.createTable("syspinghour", vo.getId() + "", "syspinghour");// Ping
						ctable.createTable("syspingday", vo.getId() + "", "syspingday");// Ping
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("myping", vo.getId() + "", "myping");// Ping
						ctable.createTable("mypinghour", vo.getId() + "", "mypinghour");// Ping
						ctable.createTable("mypingday", vo.getId() + "", "mypingday");// Ping
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("myping", vo.getId() + "", "myping");// Ping
						ctable.createTable("mypinghour", vo.getId() + "", "mypinghour");// Ping
						ctable.createTable("mypingday", vo.getId() + "", "mypingday");// Ping
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("informixping", vo.getId() + "", "informixping");// Ping
						ctable.createTable("informixpinghour", vo.getId() + "", "informixpinghour");// Ping
						ctable.createTable("informixpingday", vo.getId() + "", "informixpingday");// Ping
						ctable.createInformixLogTable(conn, "informixlog", vo.getId() + "", "informixlog");// 存放日志信息
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.createTable("informixping", vo.getId() + "", "informixping");// Ping
						ctable.createTable("informixpinghour", vo.getId() + "", "informixpinghour");// Ping
						ctable.createTable("informixpingday", vo.getId() + "", "informixpingday");// Ping
	...
	public boolean delete(String id) {
		...
		try {
			...
			if (typevo.getDbtype().equalsIgnoreCase("sqlserver")) {
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("sqlping", id, "sqlping");// Ping
						ctable.deleteTable("sqlpinghour", id, "sqlpinghour");// Ping
						ctable.deleteTable("sqlpingday", id, "sqlpingday");// Ping
						ctable.dropDbconfigInfo(conn, "system_sqldbconf", id);// 告警阀值
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("sqlping", id, "sqlping");// Ping
						ctable.dropSeq1(conn, "sqlping", id);// 删除序列
						ctable.deleteTable("sqlpinghour", id, "sqlpinghour");// Ping
						ctable.dropSeq1(conn, "sqlpinghour", id);// 删除序列
						ctable.deleteTable("sqlpingday", id, "sqlpingday");// Ping
						ctable.dropSeq1(conn, "sqlpingday", id);// 删除序列
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("oraping", id, "oraping");// Ping
						ctable.deleteTable("orapinghour", id, "orapinghour");// Ping
						ctable.deleteTable("orapingday", id, "orapingday");// Ping
						ctable.dropDbconfigInfo(conn, "system_oraspaceconf", id);// 告警阀值
						conn.addBatch("delete from system_orasessiondata where serverip='" + id + "' and dbname='" + vo.getDbName() + "'");
						conn.executeBatch();
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("oraping", id, "oraping");// Ping
						ctable.dropSeq1(conn, "oraping", id);// 删除序列
						ctable.deleteTable("orapinghour", id, "orapinghour");// Ping
						ctable.dropSeq1(conn, "orapinghour", id);// 删除序列
						ctable.deleteTable("orapingday", id, "orapingday");// Ping
						ctable.dropSeq1(conn, "orapingday", id);// 删除序列
						ctable.dropDbconfigInfo(conn, "system_oraspaceconf", id);// 告警阀值
						conn.addBatch("delete from system_orasessiondata where serverip='" + id + "' and dbname='" + vo.getDbName() + "'");
						conn.executeBatch();
					}
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("db2ping", id, "db2ping");// Ping
						ctable.deleteTable("db2pinghour", id, "db2pinghour");// Ping
						ctable.deleteTable("db2pingday", id, "db2pingday");// Ping
						ctable.dropDbconfigInfo(conn, "system_db2spaceconf", id);// 告警阀值
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("db2ping", id, "db2ping");// Ping
						ctable.dropSeq1(conn, "db2ping", id);// 删除序列
						ctable.deleteTable("db2pinghour", id, "db2pinghour");// Ping
						ctable.dropSeq1(conn, "db2pinghour", id);// 删除序列
						ctable.deleteTable("db2pingday", id, "db2pingday");// Ping
						ctable.dropSeq1(conn, "db2pingday", id);// 删除序列
						ctable.dropDbconfigInfo(conn, "system_db2spaceconf", id);// 告警阀值
					}
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("sysping", id, "sysping");// Ping
						ctable.deleteTable("syspinghour", id, "syspinghour");// Ping
						ctable.deleteTable("syspingday", id, "syspingday");// Ping
						ctable.dropDbconfigInfo(conn, "system_sybspaceconf", id);// 告警阀值
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("sysping", id, "sysping");// Ping
						ctable.dropSeq1(conn, "sysping", id);// 删除序列
						ctable.deleteTable("syspinghour", id, "syspinghour");// Ping
						ctable.dropSeq1(conn, "syspinghour", id);// 删除序列
						ctable.deleteTable("syspingday", id, "syspingday");// Ping
						ctable.dropSeq1(conn, "syspingday", id);// 删除序列
						ctable.dropDbconfigInfo(conn, "system_sybspaceconf", id);// 告警阀值
					}
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("myping", id, "myping");// Ping
						ctable.deleteTable("mypinghour", id, "mypinghour");// Ping
						ctable.deleteTable("mypingday", id, "mypingday");// Ping
						ctable.dropDbconfigInfo(conn, "system_mysqlspaceconf", id);// 告警阀值
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("myping", id, "myping");// Ping
						ctable.dropSeq1(conn, "myping", id);// 删除序列
						ctable.deleteTable("mypinghour", id, "mypinghour");// Ping
						ctable.dropSeq1(conn, "mypinghour", id);// 删除序列
						ctable.deleteTable("mypingday", id, "mypingday");// Ping
						ctable.dropSeq1(conn, "mypingday", id);// 删除序列
						ctable.dropDbconfigInfo(conn, "system_mysqlspaceconf", id);// 告警阀值
					}
				...
				try {
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("informixping", id, "informixping");// Ping
						ctable.deleteTable("informixpinghour", id, "informixpinghour");// Ping
						ctable.deleteTable("informixpingday", id, "informixpingday");// Ping
						ctable.dropDbconfigInfo(conn, "system_infomixspaceconf", id);// 告警阀值
						ctable.deleteTable("informixlog", id, "informixlog");// 日志信息
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						ctable.deleteTable("informixping", id, "informixping");// Ping
						ctable.dropSeq1(conn, "informixping", id);// 删除序列
						ctable.deleteTable("informixpinghour", id, "informixpinghour");// Ping
						ctable.dropSeq1(conn, "informixpinghour", id);// 删除序列
						ctable.deleteTable("informixpingday", id, "informixpingday");// Ping
						ctable.dropSeq1(conn, "informixpingday", id);// 删除序列
						ctable.dropDbconfigInfo(conn, "system_informixspaceconf", id);// 告警阀值
						ctable.deleteTable("informixlog", id, "informixlog");// 日志信息
						ctable.dropSeq1(conn, "informixlog", id);// 删除序列
					}
	...
	public synchronized boolean createHostData(PingCollectEntity pingdata) {
		...
		try {
			...
			if (pingdata.getCategory().equalsIgnoreCase("ORAPing")) {
				...
				List list = dao.loadAll(" where ip_address = '" + ip + "' and dbtype='" + dbtype.getId() + "'");
			...
			if (pingdata.getRestype().equals("dynamic")) {
				...
				if (!dbid.equals("")) {
					...
					String sql = "insert into " + tablename + "(ipaddress,restype,category,entity,subentity,unit,chname,bak,count,thevalue,collecttime) " + "values('" + pingdata.getIpaddress() + "','" + pingdata.getRestype() + "','"
							+ pingdata.getCategory() + "','" + pingdata.getEntity() + "','" + pingdata.getSubentity() + "','" + pingdata.getUnit() + "','" + pingdata.getChname() + "','" + pingdata.getBak() + "'," + pingdata.getCount()
	...
	public boolean addOracle_sessiondata(Oracle_sessiondata os) throws Exception {
		...
		try {
			...
			String sql = "insert into system_orasessiondata(serverip,dbname,machine,username,program,status,sessiontype,command,logontime,mon_time) " + "values('" + os.getServerip() + "','" + os.getDbname() + "','" + os.getMachine()
					+ "','" + os.getUsername() + "','" + os.getProgram() + "','" + os.getStatus() + "','" + os.getSessiontype() + "','" + os.getCommand();
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "'" + logontime + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + logontime + "','YYYY-MM-DD HH24:MI:SS'),to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			}
	...
	public boolean addOracle_nmssessiondata(Oracle_sessiondata os) throws Exception {
		...
		try {
			...
			dd = os.getMon_time();
			String montime = sdf.format(dd);
			String sql = "insert into nms_orasessiondata(serverip,dbname,machine,username,program,status,sessiontype,command,logontime,mon_time) " + "values('" + os.getServerip() + "','" + os.getDbname() + "','" + os.getMachine() + "','"
					+ os.getUsername() + "','" + os.getProgram() + "','" + os.getStatus() + "','" + os.getSessiontype() + "','" + os.getCommand();
	...
	public boolean addOracle_nmsoraspaces(String serverip, String tablespace, String free_mb, String size_mb, String percent_free, String file_name, String status) throws Exception {
		...
		try {
			...
			String sql = "insert into nms_oraspaces(serverip,tablespace,free_mb,size_mb,percent_free,file_name,status,mon_time) " + "values('" + serverip + "','" + tablespace + "','" + free_mb + "','" + size_mb + "','" + percent_free
					+ "','" + file_name + "','" + status;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			}
	...
	public boolean addOracle_nmsorasys(String serverip, String INSTANCE_NAME, String HOST_NAME, String DBNAME, String VERSION, String STARTUP_TIME, String status, String ARCHIVER, String BANNER, String java_pool) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_orasys(serverip,INSTANCE_NAME,HOST_NAME,DBNAME,VERSION,STARTUP_TIME,status,ARCHIVER,BANNER,java_pool,mon_time) " + "values('" + serverip + "','" + INSTANCE_NAME + "','" + INSTANCE_NAME + "','"
					+ DBNAME + "','" + VERSION + "','" + STARTUP_TIME + "','" + status + "','" + ARCHIVER + "','" + BANNER + "','" + java_pool;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsorabanner(String serverip, String detail) throws Exception {
		DBManager dbmanager = new DBManager();
		try {
			String sql = "insert into nms_orabanner(serverip,detail) " + "values('" + serverip + "','" + detail + "')";
			dbmanager.executeUpdate(sql);
		} catch (Exception e) {
			e.printStackTrace();
			return false;
	...
	public boolean addOracle_nmsorarollback(String serverip, String rollback, String wraps, String shrink, String ashrink, String extend) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_orarollback(serverip,rollback,wraps,shrink,ashrink,extend,mon_time) " + "values('" + serverip + "','" + rollback + "','" + wraps + "','" + shrink + "','" + ashrink + "','" + extend;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoralock(String serverip, String username, String status, String machine, String sessiontype, String logontime, String program, String locktype, String lmode, String requeststr) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oralock(serverip,username,status,machine,sessiontype,logontime,program,locktype,lmode,requeststr,mon_time) " + "values('" + serverip + "','" + username + "','" + status + "','" + machine + "','"
					+ sessiontype + "','" + logontime + "','" + program + "','" + locktype + "','" + lmode + "','" + requeststr;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoratables(String serverip, String segment_name, String spaces) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oratables(serverip,segment_name,spaces,mon_time) " + "values('" + serverip + "','" + segment_name + "','" + spaces;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoratopsql(String serverip, String sql_text, String pct_bufgets, String username) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oratopsql(serverip,sql_text,pct_bufgets,username,mon_time) " + "values('" + serverip + "','" + sql_text + "','" + pct_bufgets + "','" + username;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoracontrfile(String serverip, String status, String name, String is_recovery_dest_file, String block_size, String file_size_blks) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oracontrfile(serverip,status,name,is_recovery_dest_file,block_size,file_size_blks,mon_time) " + "values('" + serverip + "','" + status + "','" + name + "','" + is_recovery_dest_file + "','"
	...
	public boolean addOracle_nmsoraisarchive(String serverip, String created, String log_mode) throws Exception {
		...
		try {
			...
			String sql = "insert into nms_oraisarchive(serverip,created,log_mode,mon_time) " + "values('" + serverip + "','" + created + "','" + log_mode;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "','" + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	 ...
	 * @throws Exception
	 */
	public boolean addOracle_nmsorakeepobj(String serverip, String owner, String name, String db_link, String namespace, String type, String sharable_mem, String loads, String executions, String locks, String pins, String kept,
			String child_latch, String invalidations) throws Exception {
		DBManager dbmanager = new DBManager();
		try {
			Calendar tempCal = Calendar.getInstance();
			Date cc = tempCal.getTime();
			...
			sBuffer.append("insert into nms_orakeepobj(serverip, owner, name, db_link, namespace, type, sharable_mem, loads," + " executions, locks, pins, kept, child_latch, invalidations, mon_time) ");
	...
	public boolean addOracle_nmsoraextent(String serverip, String tablespace_name, String extents) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oraextent(serverip,tablespace_name,extents,mon_time) " + "values('" + serverip + "','" + tablespace_name + "','" + extents;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoralogfile(String serverip, String group, String status, String type, String member) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oralogfile(serverip,groupstr,status,type,member,mon_time) " + "values('" + serverip + "','" + group + "','" + status + "','" + type + "','" + member;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsorauserinfo(String serverip, Hashtable returnHash, String lable) throws Exception {
		...
		try {
			...
			if ("0".equals(lable)) {
				...
				sBuffer.append("insert into nms_orauserinfo(serverip, parsing_user_id, cpu_time, sorts, buffer_gets, " + "runtime_mem, version_count, disk_reads,label, mon_time) ");
				sBuffer.append(" values('");
				sBuffer.append(serverip);
				sBuffer.append("','");
				...
				sBuffer = new StringBuffer();
				sBuffer.append("insert into nms_orauserinfo(serverip, users,label, mon_time) ");
				sBuffer.append(" values('");
				sBuffer.append(serverip);
				sBuffer.append("','");
	...
	public boolean addOracle_nmsoracursors(String serverip, String curconnect, String opencur) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oracursors(serverip,curconnect,opencur,mon_time) " + "values('" + serverip + "','" + curconnect + "','" + opencur;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsorawait(String serverip, String event, String prev, String curr, String tot) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_orawait(serverip,event,prev,curr,tot,mon_time) " + "values('" + serverip + "','" + event + "','" + prev + "','" + curr + "','" + tot;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoradbio(String serverip, String name, String file, String pyr, String pbr, String pyw, String pbw) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oradbio(serverip, name, filename, pyr, pbr, pyw, pbw,mon_time) " + "values('" + serverip + "','" + name + "','" + file + "','" + pyr + "','" + pbr + "','" + pyw + "','" + pbw;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracle_nmsoramemvalue(String serverip, Hashtable memValue) throws Exception {
		...
		try {
			...
			sBuffer.append("insert into nms_oramemvalue(serverip, agg_pga_auto_target, tpga_used_manu_workareas, total_pga_inuse, "
					+ "maximum_pga_allocated,cache_hit_percentage,recycle_buffer_cache,keep_buffer_cache,process_count ,tpga_used_auto_workareas,"
					+ "asm_buffer_cache,over_allocation_count,bytes_processed,java_pool,maxpga_used_manu_workareas,streams_pool," + "default_2k_buffer_cache,max_processes_count,total_pga_allocated,default_4k_buffer_cache,shared_pool,"
					+ "default_32k_buffer_cache,default_buffer_cache,large_pool,agg_pga_target_parameter ,default_16k_buffer_cache,"
					+ "global_memory_bound,default_8k_buffer_cache,extra_bytes_read_written,pga_mem_freed_back_os,tot_free_pga_memory,recom_count_total," + "maxpga_used_auto_workareas,mon_time) ");
			sBuffer.append(" values('");
			sBuffer.append(serverip);
			sBuffer.append("','");
	...
	public boolean addOracle_nmsoramemperfvalue(String serverip, String pctmemorysorts, String pctbufgets, String dictionarycache, String buffercache, String librarycache) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_oramemperfvalue(serverip, pctmemorysorts, pctbufgets, dictionarycache, buffercache, librarycache,mon_time) " + "values('" + serverip + "','" + pctmemorysorts + "','" + pctbufgets + "','"
	...
	public boolean addOracle_nmsorastatus(String serverip, String lstrnStatu, String status) throws Exception {
		...
		try {
			...
			Date cc = tempCal.getTime();
			String montime = sdf.format(cc);
			String sql = "insert into nms_orastatus(serverip, lstrnstatu, status,mon_time) " + "values('" + serverip + "','" + lstrnStatu + "','" + status;
			if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + montime + "')";
			} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
				sql = sql + "'," + "to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public Vector getOracle_nmsorajobs(String serverip) throws Exception {
		String slq = "select * from nms_orajob where serverip = '" + serverip + "'";
		Vector retValue = new Vector();
		DBManager dbmanager = new DBManager();
		try {
			rs = dbmanager.executeQuery(slq);
	...
	public Hashtable getOracle_nmsorauserinfo(String serverip) throws Exception {
		...
		String sql_1 = "select users from nms_orauserinfo where serverip = '" + serverip + "' and label = '1'";
	...
	public Hashtable getOracle_nmsoramemvalue(String serverip) throws Exception {
		...
		try {
			rs = dbmanager.executeQuery(slq);
			while (rs.next()) {
				retValue.put("aggregate_PGA_auto_target", rs.getString("agg_pga_auto_target"));
				retValue.put("total_PGA_used_for_manual_workareas", rs.getString("tpga_used_manu_workareas"));
				...
				retValue.put("total_PGA_used_for_auto_workareas", rs.getString("tpga_used_auto_workareas"));
				...
				retValue.put("maximum_PGA_used_for_manual_workareas", rs.getString("maxpga_used_manu_workareas"));
				...
				retValue.put("aggregate_PGA_target_parameter", rs.getString("agg_pga_target_parameter"));
				...
				retValue.put("PGA_memory_freed_back_to_OS", rs.getString("pga_mem_freed_back_os"));
				retValue.put("total_freeable_PGA_memory", rs.getString("tot_free_pga_memory"));
				retValue.put("recompute_count_(total)", rs.getString("recom_count_total"));
				retValue.put("maximum_PGA_used_for_auto_workareas", rs.getString("maxpga_used_auto_workareas"));
			}
			rs.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Boolean clearMysqlTableData(String tableName, String serverip) {
		DBManager dbmanager = new DBManager();
		try {
			String sql = "delete from " + tableName + " where serverip='" + serverip + "' and typename <> 'status'";
			dbmanager.executeUpdate(sql);
		} catch (Exception e) {
			e.printStackTrace();
			return false;
	...
	public Boolean clearTable(String tableName, String ipaddress) {
		DBManager dbmanager = new DBManager();
		try {
			String sql = "delete from " + tableName + " where ipaddress='" + ipaddress + "'";
			dbmanager.executeUpdate(sql);
		} catch (Exception e) {
			e.printStackTrace();
			return false;
	...
	public boolean addSqlserver_nmsstatus(String serverip, String status) throws Exception {
		...
		try {
			...
			String sql = "";
			if (SystemConstant.DBType.equals("mysql")) {
				sql = "insert into nms_sqlserverstatus(serverip,status,mon_time) " + "values('" + serverip + "','" + status + "','" + montime + "')";
			} else if (SystemConstant.DBType.equals("oracle")) {
				sql = "insert into nms_sqlserverstatus(serverip,status,mon_time) " + "values('" + serverip + "','" + status + "',to_date('" + montime + "','yyyy-mm-dd hh24:mi:ss'))";
			}
			dbmanager.executeUpdate(sql);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean addSqlserver_nmspages(String serverip, Hashtable pages) throws Exception {
		...
		try {
			...
			String montime = sdf.format(cc);
			StringBuffer sBuffer = new StringBuffer();
			sBuffer.append("insert into nms_sqlserverpages(serverip, bufferCacheHitRatio, planCacheHitRatio, " + "cursorManagerByTypeHitRatio, catalogMetadataHitRatio, dbOfflineErrors, killConnectionErrors, userErrors,"
					+ " infoErrors, sqlServerErrors_total, cachedCursorCounts, cursorCacheUseCounts, cursorRequests_total, " + "activeCursors,cursorMemoryUsage,cursorWorktableUsage,activeOfCursorPlans,dbPages,totalPageLookups,"
	...
	public boolean addSqlserver_nmslocks(String serverip, Hashtable locks) throws Exception {
		...
		try {
			...
			String montime = sdf.format(cc);
			StringBuffer sBuffer = new StringBuffer();
			sBuffer.append("insert into nms_sqlserverlocks(serverip, lockRequests, lockRequestsRate, " + "lockWaits, lockWaitsRate, lockTimeouts,lockTimeoutsRate,deadLocks,deadLocksRate,avgWaitTime,"
	...
	public boolean addSqlserver_nmssqls(String serverip, Hashtable sqls) throws Exception {
		...
		try {
			...
			String montime = sdf.format(cc);
			StringBuffer sBuffer = new StringBuffer();
			sBuffer.append("insert into nms_sqlserversqls(serverip, batchRequests, batchRequestsRate, " + "sqlCompilations, sqlCompilationsRate, sqlRecompilation,sqlRecompilationRate,autoParams,autoParamsRate,failedAutoParams,"
	...
	public boolean addSqlserver_nmsmems(String serverip, Hashtable mems) throws Exception {
		...
		try {
			...
			String montime = sdf.format(cc);
			StringBuffer sBuffer = new StringBuffer();
			sBuffer.append("insert into nms_sqlservermems(serverip, totalMemory, sqlMem, " + "optMemory, memGrantPending, memGrantSuccess,lockMem,conMemory,grantedWorkspaceMem,mon_time)");
			sBuffer.append(" values('");
			sBuffer.append(serverip);
			sBuffer.append("','");
	...
	public boolean addSqlserver_nmsstatisticsHash(String serverip, Hashtable statisticsHash) throws Exception {
		...
		try {
			...
			sBuffer.append("lj_logWriteWaits,lj_logBufferWaits,lj_networkIOWaits,lj_pageIOLatchWaits,lj_pageLatchWaits,lj_nonPageLatchWaits,lj_waitForTheWorker,lj_workspaceSynWaits ,lj_traOwnershipWaits ,mon_time)");
			sBuffer.append(" values('");
			sBuffer.append(serverip);
			sBuffer.append("','");
	...
	public Hashtable getSqlserver_nmsstatisticsHash(String serverip) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				retValue.put("pingjun_memoryGrantQueueWaits", rs.getString("pj_memGrantQueWaits"));
				retValue.put("pingjun_threadSafeMemoryObjectWaits", rs.getString("pj_thdSafeMemObjWaits"));
				retValue.put("pingjun_logWriteWaits", rs.getString("pj_logWriteWaits"));
				retValue.put("pingjun_logBufferWaits", rs.getString("pj_logBufferWaits"));
				retValue.put("pingjun_networkIOWaits", rs.getString("pj_networkIOWaits"));
				retValue.put("pingjun_pageIOLatchWaits", rs.getString("pj_pageIOLatchWaits"));
				retValue.put("pingjun_pageLatchWaits", rs.getString("pj_pageLatchWaits"));
				retValue.put("pingjun_nonPageLatchWaits", rs.getString("pj_nonPageLatchWaits"));
				retValue.put("pingjun_waitForTheWorker", rs.getString("pj_waitForTheWorker"));
				retValue.put("pingjun_workspaceSynchronizationWaits", rs.getString("pj_workspaceSynWaits"));
				retValue.put("pingjun_transactionOwnershipWaits", rs.getString("pj_traOwnershipWaits"));
				retValue.put("jingxing_lockWaits", rs.getString("jx_lockWaits"));
				retValue.put("jingxing_memoryGrantQueueWaits", rs.getString("jx_memGrantQueWaits"));
				retValue.put("jingxing_threadSafeMemoryObjectWaits", rs.getString("jx_thdSafeMemObjWaits"));
				retValue.put("jingxing_logWriteWaits", rs.getString("jx_logWriteWaits"));
				retValue.put("jingxing_logBufferWaits", rs.getString("jx_logBufferWaits"));
				retValue.put("jingxing_networkIOWaits", rs.getString("jx_networkIOWaits"));
				retValue.put("jingxing_pageIOLatchWaits", rs.getString("jx_pageIOLatchWaits"));
				retValue.put("jingxing_pageLatchWaits", rs.getString("jx_pageLatchWaits"));
				retValue.put("jingxing_nonPageLatchWaits", rs.getString("jx_nonPageLatchWaits"));
				retValue.put("jingxing_waitForTheWorker", rs.getString("jx_waitForTheWorker"));
				retValue.put("jingxing_workspaceSynchronizationWaits", rs.getString("jx_workspaceSynWaits"));
				retValue.put("jingxing_transactionOwnershipWaits", rs.getString("jx_traOwnershipWaits"));
				retValue.put("qidong_lockWaits", rs.getString("qd_lockWaits"));
				retValue.put("qidong_memoryGrantQueueWaits", rs.getString("qd_memGrantQueWaits"));
				retValue.put("qidong_threadSafeMemoryObjectWaits", rs.getString("qd_thdSafeMemObjWaits"));
				retValue.put("qidong_logWriteWaits", rs.getString("qd_logWriteWaits"));
				retValue.put("qidong_logBufferWaits", rs.getString("qd_logBufferWaits"));
				retValue.put("qidong_networkIOWaits", rs.getString("qd_networkIOWaits"));
				retValue.put("qidong_pageIOLatchWaits", rs.getString("qd_pageIOLatchWaits"));
				retValue.put("qidong_pageLatchWaits", rs.getString("qd_pageLatchWaits"));
				retValue.put("qidong_nonPageLatchWaits", rs.getString("qd_nonPageLatchWaits"));
				retValue.put("qidong_waitForTheWorker", rs.getString("qd_waitForTheWorker"));
				retValue.put("qidong_workspaceSynchronizationWaits", rs.getString("qd_workspaceSynWaits"));
				retValue.put("qidong_transactionOwnershipWaits", rs.getString("qd_traOwnershipWaits"));
				retValue.put("leiji_lockWaits", rs.getString("lj_lockWaits"));
				retValue.put("leiji_memoryGrantQueueWaits", rs.getString("lj_memGrantQueWaits"));
				retValue.put("leiji_threadSafeMemoryObjectWaits", rs.getString("lj_thdSafeMemObjWaits"));
				retValue.put("leiji_logWriteWaits", rs.getString("lj_logWriteWaits"));
				retValue.put("leiji_logBufferWaits", rs.getString("lj_logBufferWaits"));
				retValue.put("leiji_networkIOWaits", rs.getString("lj_networkIOWaits"));
				retValue.put("leiji_pageIOLatchWaits", rs.getString("lj_pageIOLatchWaits"));
				retValue.put("leiji_pageLatchWaits", rs.getString("lj_pageLatchWaits"));
				retValue.put("leiji_nonPageLatchWaits", rs.getString("lj_nonPageLatchWaits"));
				retValue.put("leiji_waitForTheWorker", rs.getString("lj_waitForTheWorker"));
				retValue.put("leiji_workspaceSynchronizationWaits", rs.getString("lj_workspaceSynWaits"));
				retValue.put("leiji_transactionOwnershipWaits", rs.getString("lj_traOwnershipWaits"));
			}
			rs.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public Hashtable getSqlserver_nmsdbvalue(String serverip) throws Exception {
		String sql_0 = "select usedperc,usedsize,sizes,logname from nms_sqlserverdbvalue where serverip = '" + serverip + "' and label = '0'";
		String sql_1 = "select usedperc,usedsize,sizes,dbname from nms_sqlserverdbvalue where serverip = '" + serverip + "' and label = '1'";
	...
	public boolean addInformix_nmssession(String serverip, Hashtable session) throws Exception {
		...
		try {
			...
			String montime = sdf.format(cc);
			StringBuffer sBuffer = new StringBuffer();
			sBuffer.append("insert into nms_informixsession(serverip, bufwrites, pagwrites,pagreads,locksheld ,bufreads,accesses,");
	 ...
	 * @return
	 */
	public boolean addMysql_nmsinfo(String serverip, Hashtable monitorValue, String dbName) {
		if (monitorValue == null || monitorValue.size() == 0) {
			return false;
		}
		String status = "0";
		String runningflag = (String) monitorValue.get("runningflag");
		if (runningflag.equals("正在运行")) {
			status = "1";
		}
		DBManager dbmanager = new DBManager();
		try {
			...
			if (SystemConstant.DBType.equals("mysql")) {
				...
				sqlBuffer_0.append("',to_date('" + montime + "','yyyy-mm-dd hh24:mi:ss'))");
			}
			...
			if (monitorValue.containsKey(dbName)) {
				retValue = (Hashtable) monitorValue.get(dbName);
			}
			if (retValue == null) {
				return false;
			}
			...
			if (retValue.containsKey("global_status")) {
				...
				for (int j = 0; j < global_status.size(); j++) {
					...
					sqlBuffer.append("','");
					sqlBuffer.append(tempHashtable.get("variable_value"));
					sqlBuffer.append("','");
					...
					if (SystemConstant.DBType.equals("mysql")) {
						...
						sqlBuffer.append("',to_date('" + montime + "','yyyy-mm-dd hh24:mi:ss'))");
					}
					dbmanager.addBatch(sqlBuffer.toString());
				}
			...
			if (retValue.containsKey("variables")) {
				...
				for (int j = 0; j < variables.size(); j++) {
					...
					StringBuffer sqlBuffer = new StringBuffer();
					String value = (String.valueOf(tempHashtable.get("variable_value"))).replaceAll("\\\\", "/");
					sqlBuffer.append("insert into nms_mysqlinfo(serverip,variable_name,value,dbname,typename,mon_time) values ('");
					sqlBuffer.append(serverip);
					sqlBuffer.append("','");
					sqlBuffer.append(tempHashtable.get("variable_name"));
	...
	public Hashtable getDB2DataByServerip(String serverip) {
		...
		String[] ips = java.util.Arrays.toString(IpTranslation.getIpFromHex(ipHex)).replaceAll("\\[", "").replaceAll("\\]", "").split(",");
	...
	public boolean addOrUpdateDB2_nmsdbnames(String serverip, String[] dbnames) throws Exception {
		DBManager dbmanager = new DBManager();
		try {
			Calendar tempCal = Calendar.getInstance();
			Date cc = tempCal.getTime();
			...
			if (SystemConstant.DBType.equals("mysql")) {
				...
				sBuffer_.append("to_date('" + montime + "','yyyy-mm-dd hh24:mi:ss'))");
			}
	...
	public List getDbmonitorlist(Integer netid) throws Exception {
		...
		try {
			...
			if (netid == 99) {
				...
				query = session.createQuery("from Dbmonitorlist dbmonitorlist where dbmonitorlist.netlocation.id =" + netid + " order by dbmonitorlist.id");
			}
	...
	public List getDbserver(String type) {
		...
		Session session = null;
		try {
			Query query = session.createQuery("from Dbmonitorlist dbmonitorlist where dbmonitorlist.dict.name = '" + type + "' order by dbmonitorlist.id");
			list = query.list();
			...
			if (list != null && list.size() > 0) {
				for (int i = 0; i < list.size(); i++) {
					...
					if (type.equals("oracle")) {
						flag = getOracleIsOK(db.getIpAddress(), Integer.parseInt(db.getPort()), db.getDbName(), db.getUser(), db.getPassword());
						...
						flag = getMySqlIsOk(db.getIpAddress(), db.getPort(),db.getUser(), db.getPassword(), db.getDbName());
					} else if (type.equals("informix")) {
						flag = getInformixIsOk(db.getIpAddress(), db.getPort(), db.getUser(), db.getPassword(), db.getDbName(), db.getAlias());
						...
						for (int k = 0; k < dbs.length; k++) {
							String dbStr = dbs[k];
							boolean db2IsOK = getDB2IsOK(db.getIpAddress(), Integer.parseInt(db.getPort()), dbStr, db.getUser(), db.getPassword());
							if (!db2IsOK) {
								allFlag = 1;
							}
						}
	...
	public List getSqlserverDbByServer(String serverip) throws Exception {
		...
		try {
			Query query = session.createQuery("select distinct a.dbname from Sqlserver_processdata a where a.serverip ='" + serverip + "'");
			list = query.list();
	...
	public List getSqlserverInfo(String serverip, String dbname, String startdate, String todate) throws Exception {
		...
		Session session = null;
		try {
			Query query = session.createQuery("select distinct a.serverip,a.spid,a.dbname,a.username,a.cpu,a.physical_io,a.memusage," + "a.status,a.hostname,a.program_name,a.login_time " + "from Sqlserver_processdata a where "
					+ "a.serverip ='" + serverip + "' and a.dbname='" + dbname + "' " + "and a.login_time >=to_date('" + startdate + "','YYYY-MM-DD HH24:MI:SS') and a.login_time<=to_date('" + todate
	...
	public Hashtable getAllOracleData(String ip, int port, String db, String username, String password) throws Exception {
		...
		String sqlSession = "select substr(s.username,1,18) username,s.status status,s.MACHINE machine," + "s.type sessiontype, to_char(s.LOGON_TIME,'yyyy-mm-dd hh24-mi-ss') logontime,"
				+ "substr(s.program,1,15) program,decode(s.command, 0,'No Command',1," + "'Create Table',2,'Insert',3,'Select',6,'Update',7,'Delete',9," + "'Create Index',15,'Alter Table',21,'Create View',23,'Validate Index',35,"
				+ "'Alter Database',39,'Create Tablespace',41,'Drop Tablespace',40,'Alter Tablespace'" + ",53,'Drop User',62,'Analyze Table',63,'Analyze Index',s.command||': Other') "
				+ "command from v$session s,v$process p,v$transaction t,v$rollstat r,v$rollname n " + "where s.paddr = p.addr and   s.taddr = t.addr (+) and   t.xidusn = r.usn (+) and" + "  r.usn = n.usn (+) order by logon_time desc";
		String sqlTablespace = "select a.tablespace_name \"Tablespace\", " + "round(a.bytes/1024/1024,0) \"Size MB\"," + "round((decode(b.bytes,null,0,b.bytes))/1024/1024,0) \"Free MB\","
				+ "round((decode(b.bytes,null,0,b.bytes)) / a.bytes * 100,1) \"Percent Free\"," + "c.file_name,c.status from   sys.sm$ts_avail a, sys.sm$ts_free b,dba_data_files c  "
				+ "where  a.tablespace_name = b.tablespace_name(+) and a.tablespace_name=c.tablespace_name " + "order by a.tablespace_name";
		String sqlRollback = "select distinct name \"Rollback Segment\", " + "optsize \"Optimal\",shrinks, AveShrink \"Average Shrink\",Wraps, " + "Extends from v$rollstat,v$rollname where " + "v$rollstat.USN=v$rollname.USN order by name";
		...
		String sqlTsql = "select sql_text,pct_bufgets,username from (select rank() over(order by disk_reads desc) as rank_bufgets,"
				+ "to_char(100 * ratio_to_report(disk_reads) over(), '999.99') pct_bufgets,sql_text,b.username as username from" + " v$sqlarea,dba_users b where b.user_id = PARSING_USER_ID) where rank_bufgets < 11";
		...
		String sqlExtent = "select a.tablespace_name, sum(a.extents) from dba_segments a, dba_tablespaces b " + "where a.tablespace_name = b.tablespace_name and b.extent_management = 'DICTIONARY' "
		...
		String sqldbio = "SELECT DF.TABLESPACE_NAME NAME,DF.FILE_NAME FILENAME,F.PHYRDS PYR," + "F.PHYBLKRD PBR,F.PHYWRTS PYW, F.PHYBLKWRT PBW FROM V$FILESTAT F, DBA_DATA_FILES DF WHERE F.FILE# = DF.FILE_ID "
		...
		try {
			...
			String sql_1 = "select distinct substr(s.username,1,18) username,s.sid as sid,s.status status,s.MACHINE machine," + "s.type sessiontype,to_char(s.LOGON_TIME,'yyyy-mm-dd hh24-mi-ss') logontime,"
	...
	public Hashtable getAllOracleData(String ip, int port, String db, String username, String password, Hashtable collectHash) throws Exception {
		...
		String sqlTablespace = "SELECT UPPER(F.TABLESPACE_NAME) \"Tablespace\", D.TOT_GROOTTE_MB \"Size MB\",F.TOTAL_BYTES \"Free MB\",chunks,"
				+ "TO_CHAR(ROUND( F.TOTAL_BYTES / D.TOT_GROOTTE_MB * 100,2),'990.99') \"Percent Free\" ,c.file_name,c.status " + "FROM (SELECT TABLESPACE_NAME,　ROUND(SUM(BYTES) / (1024 * 1024), 2) TOTAL_BYTES,count(*) chunks,"
				+ "ROUND(MAX(BYTES) / (1024 * 1024), 2) MAX_BYTES　　FROM SYS.DBA_FREE_SPACE GROUP BY TABLESPACE_NAME) F,　　"
				+ "(SELECT DD.TABLESPACE_NAME,　　ROUND(SUM(DD.BYTES) / (1024 * 1024), 2) TOT_GROOTTE_MB　　FROM SYS.DBA_DATA_FILES DD　　" + "GROUP BY DD.TABLESPACE_NAME) D,    dba_data_files c　　WHERE D.TABLESPACE_NAME = F.TABLESPACE_NAME "
	...
	public Vector getSqlserverAltfile(String ip, String username, String password) throws Exception {
		...
		String sql = "select a.fileid as fileid,floor(a.size/128) as size,b.name as dbname,a.name as name,a.filename as filename " + "from sysaltfiles a,sysdatabases b where a.dbid=b.dbid";
		JdbcUtil util = null;
		ResultSet rs = null;
		try {
	...
	public Vector getSqlserverProcesses(String ip, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:jtds:sqlserver://" + ip + ";DatabaseName=master;charset=GBK;SelectMethod=CURSOR";
		String sql = "select distinct a.spid,a.waittime,a.lastwaittype,a.waitresource,b.name as dbname,c.name as " + "username,a.cpu,a.physical_io,a.memusage,a.login_time,a.last_batch,a.status,a.hostname,"
				+ "a.program_name,a.hostprocess,a.cmd,a.nt_domain,a.nt_username,a.net_library,a.loginame from " + "sysprocesses a,sysdatabases b,sysusers c where a.dbid= b.dbid and a.uid=c.uid";
		JdbcUtil util = null;
		ResultSet rs = null;
		try {
			util = new JdbcUtil(dburl, username, password);
	...
	public Vector getSqlserverLockinfo(String ip, String username, String password) throws Exception {
		...
		String sql = "select distinct a.rsc_text,a.rsc_dbid,b.name as dbname,a.rsc_indid,a.rsc_objid,a.rsc_type,a.rsc_flag,a.req_mode,a.req_status,"
				+ "a.req_refcnt,a.req_cryrefcnt,a.req_lifetime,a.req_spid,a.req_ecid,a.req_ownertype,a.req_transactionID from syslockinfo a," + "sysdatabases b where a.rsc_dbid=b.dbid;";
		JdbcUtil util = null;
		ResultSet rs = null;
		try {
			util = new JdbcUtil(dburl, username, password);
	...
	public Vector getOracleTableinfo(String ip, int port, String db, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:oracle:thin:@" + ip + ":" + port + ":" + db;
		String sql = "select a.tablespace_name \"Tablespace\", " + "round(a.bytes/1024/1024,0) \"Size MB\"," + "round((decode(b.bytes,null,0,b.bytes))/1024/1024,0) \"Free MB\","
				+ "round((decode(b.bytes,null,0,b.bytes)) / a.bytes * 100,1) \"Percent Free\"," + "c.file_name,c.status from   sys.sm$ts_avail a, sys.sm$ts_free b,dba_data_files c  "
				+ "where  a.tablespace_name = b.tablespace_name(+) and a.tablespace_name=c.tablespace_name " + "order by a.tablespace_name";
		OracleJdbcUtil util = null;
		ResultSet rs = null;
	...
	public Vector getOracleSort(String ip, int port, String db, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:oracle:thin:@" + ip + ":" + port + ":" + db;
		String sql = "select a.value \"Disk Sorts\",b.value \"Memory Sorts\",round((100 * b.value) /" + "decode((a.value + b.value), 0, 1, (a.value + b.value)),2) \"Pct Memory Sorts\" "
	...
	public Vector getOracleExtent(String ip, int port, String db, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:oracle:thin:@" + ip + ":" + port + ":" + db;
		String sql = "select a.tablespace_name, sum(a.extents) from dba_segments a, dba_tablespaces b " + "where a.tablespace_name = b.tablespace_name and b.extent_management = 'DICTIONARY' "
				+ "group by a.tablespace_name order by sum(a.extents)";
		OracleJdbcUtil util = null;
		ResultSet rs = null;
		try {
	...
	public SybaseVO getSysbaseInfo(String ip, int port, String username, String password) throws Exception {
		...
		try {
			...
			// cpu利用率(已经乘以了100) %
			StringBuffer Cpu_busy_rate = new StringBuffer("select convert(decimal(10,2),round(@@cpu_busy*100/((@@cpu_busy+@@io_busy+@@idle)*1.00),2))");
			...
			// IO利用率(已经乘以了100) %
			StringBuffer Io_busy_rate = new StringBuffer("select convert(decimal(10,2),round(@@io_busy*100/((@@cpu_busy+@@io_busy+@@idle)*1.00),2))");
			...
			// 总数据高速缓存大小 MB
			StringBuffer Total_dataCache = new StringBuffer("select convert(decimal(10,0),c.value/512.00) from sysconfigures t ,syscurconfigs c where t.comment like '%total data cache size%' and c.config=t.config");
			...
			// 总物理内存大小 MB
			StringBuffer Total_physicalMemory = new StringBuffer("select convert(decimal(10,0),c.value/512.00) from sysconfigures t ,syscurconfigs c where t.comment like '%total physical memory%' and c.config=t.config");
			...
			// Metadata缓存 MB
			StringBuffer Metadata_cache = new StringBuffer("select convert(decimal(10,0),c.value/512.00) from sysconfigures t ,syscurconfigs c where t.comment like '%Meta-Data Caches%' and c.config=t.config");
			...
			// 存储过程缓存大小 MB
			StringBuffer Procedure_cache = new StringBuffer("select convert(decimal(10,0),c.value/512.00) from sysconfigures t ,syscurconfigs c where t.comment like '%procedure cache size%' and c.config=t.config");
			...
			// 总逻辑内存大小 MB
			StringBuffer Total_logicalMemory = new StringBuffer("select convert(decimal(10,0),c.value/512.00) from sysconfigures t ,syscurconfigs c where t.comment like '%total logical memory%' and c.config=t.config");
			...
			// 数据缓存匹配度 %
			StringBuffer Data_hitrate = new StringBuffer("select convert(decimal(10,0),c.value*100/c.memory_used) from sysconfigures t ,syscurconfigs c where t.comment ='total data cache size' and c.config=t.config");
			...
			// 存储缓存匹配度 %
			StringBuffer Procedure_hitrate = new StringBuffer("select convert(decimal(10,0),c.value*200/c.memory_used) from sysconfigures t ,syscurconfigs c where t.comment ='procedure cache size' and c.config=t.config");
			...
			try {
				Map<String, Integer> names = new HashMap<String, Integer>();
				rs = util.executeQuery("select c.name,sum(a.size)*(@@maxpagesize/1024)/1024 as size,sum(a.unreservedpgs)*(@@maxpagesize/1024)/1024 as freesize from sysusages a,sysdatabases c where a.dbid=c.dbid group by c.name");
				while (rs.next()) {
	...
	public Vector getOracleSession(String ip, int port, String db, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:oracle:thin:@" + ip + ":" + port + ":" + db;
		String sql = "select substr(s.username,1,18) username,s.status status,s.MACHINE machine," + "s.type sessiontype, to_char(s.LOGON_TIME,'yyyy-mm-dd hh24-mi-ss') logontime,"
				+ "substr(s.program,1,15) program,decode(s.command, 0,'No Command',1," + "'Create Table',2,'Insert',3,'Select',6,'Update',7,'Delete',9," + "'Create Index',15,'Alter Table',21,'Create View',23,'Validate Index',35,"
				+ "'Alter Database',39,'Create Tablespace',41,'Drop Tablespace',40,'Alter Tablespace'" + ",53,'Drop User',62,'Analyze Table',63,'Analyze Index',s.command||': Other') "
				+ "command from v$session s,v$process p,v$transaction t,v$rollstat r,v$rollname n " + "where s.paddr = p.addr and   s.taddr = t.addr (+) and   t.xidusn = r.usn (+) and" + "  r.usn = n.usn (+) order by logon_time desc";
		OracleJdbcUtil util = null;
	...
	public Vector getOracleRollbackinfo(String ip, int port, String db, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:oracle:thin:@" + ip + ":" + port + ":" + db;
		String sql = "select distinct name \"Rollback Segment\", " + "optsize \"Optimal\",shrinks, AveShrink \"Average Shrink\",Wraps, " + "Extends from v$rollstat,v$rollname where " + "v$rollstat.USN=v$rollname.USN order by name";
		OracleJdbcUtil util = null;
		ResultSet rs = null;
		try {
			util = new OracleJdbcUtil(dburl, username, password);
	...
	public Vector getOracleLockinfo(String ip, int port, String db, String username, String password) throws Exception {
		Vector returnVal = new Vector();
		String dburl = "jdbc:oracle:thin:@" + ip + ":" + port + ":" + db;
		String sql = "select distinct substr(s.username,1,18) username,s.status status,s.MACHINE machine," + "s.type sessiontype,to_char(s.LOGON_TIME,'yyyy-mm-dd hh24-mi-ss') logontime,"
				+ "substr(s.program,1,15) program , a.type as locktype,a.lmode as lmode," + "a.request as request  from v$session s,v$lock a where a.sid=s.sid";
		OracleJdbcUtil util = null;
		ResultSet rs = null;
		try {
			util = new OracleJdbcUtil(dburl, username, password);
	...
	public Hashtable collectSQLServerMonitItemsDetail(String ip, String dbname, String username, String password, Hashtable gatherHash) {
		 ...
		 */
		String queryStr = "SELECT perf1.object_name, perf1.counter_name, perf1.instance_name, " + "'value' = CASE perf1.cntr_type WHEN 537003008 THEN CONVERT(FLOAT,perf1.cntr_value) /(SELECT CASE perf2.cntr_value "
				+ "WHEN 0 THEN 1 ELSE perf2.cntr_value END " + "FROM master..sysperfinfo perf2 " + "WHERE (perf1.counter_name + ' '= SUBSTRING(perf2.counter_name,1,PATINDEX('% base%', perf2.counter_name))) "
				+ "AND (perf1.instance_name = perf2.instance_name)  AND (perf2.cntr_type = 1073939459)) " + "ELSE perf1.cntr_value  END " + "FROM master..sysperfinfo perf1 " + "WHERE (perf1.cntr_type <> 1073939459)";
		try {
			util = new JdbcUtil(dburl, username, password);
			...
			for (int i = 1; i < tmpResult.length; i++) {
				...
				if (gatherHash.containsKey("wait")) {
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Lock waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_lockWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Memory grant queue waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_memoryGrantQueueWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Thread-safe momory objects waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_threadSafeMemoryObjectWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log write waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_logWriteWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log buffer waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_logBufferWaits = tmpDouble;
					}

					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Network IO waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_networkIOWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page IO latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_pageIOLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_pageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Non-Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_nonPageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Wait for the worker") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_waitForTheWorker = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Workspace synchronization waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_workspaceSynchronizationWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Transaction ownership waits") && tmpResult[i][2].trim().equalsIgnoreCase("平均等待时间(ms)")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						pingjun_transactionOwnershipWaits = tmpDouble;
					}
					tmpDouble = 0;

					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Lock waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_lockWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Memory grant queue waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_memoryGrantQueueWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Thread-safe momory objects waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_threadSafeMemoryObjectWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log write waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_logWriteWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log buffer waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_logBufferWaits = tmpDouble;
					}
					tmpDouble = 0;

					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Network IO waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_networkIOWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page IO latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_pageIOLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_pageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Non-Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_nonPageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Wait for the worker") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_waitForTheWorker = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Workspace synchronization waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_workspaceSynchronizationWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Transaction ownership waits") && tmpResult[i][2].trim().equalsIgnoreCase("正在进行的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						jingxing_transactionOwnershipWaits = tmpDouble;
					}

					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Lock waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_lockWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Memory grant queue waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_memoryGrantQueueWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Thread-safe momory objects waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_threadSafeMemoryObjectWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log write waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_logWriteWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log buffer waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_logBufferWaits = tmpDouble;
					}

					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Network IO waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_networkIOWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page IO latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_pageIOLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_pageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Non-Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_nonPageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Wait for the worker") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_waitForTheWorker = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Workspace synchronization waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_workspaceSynchronizationWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Transaction ownership waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒启动的等待数")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						qidong_transactionOwnershipWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Lock waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_lockWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Memory grant queue waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_memoryGrantQueueWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Thread-safe momory objects waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_threadSafeMemoryObjectWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log write waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_logWriteWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Log buffer waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_logBufferWaits = tmpDouble;
					}

					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Network IO waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_networkIOWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page IO latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_pageIOLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_pageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Non-Page latch waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_nonPageLatchWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Wait for the worker") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_waitForTheWorker = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Workspace synchronization waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						leiji_workspaceSynchronizationWaits = tmpDouble;
					}
					tmpDouble = 0;
					if (tmpResult[i][0].trim().equalsIgnoreCase("SQLServer:Wait Statistics") && tmpResult[i][1].trim().equalsIgnoreCase("Transaction ownership waits") && tmpResult[i][2].trim().equalsIgnoreCase("每秒的累积等待时间")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
				...
				if (gatherHash.containsKey("page")) {
					...
					/* 查找页数/分 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Page lookups/sec") || tmpResult[i][1].trim().equalsIgnoreCase("Page Requests/sec")) {
				...
				if (gatherHash.containsKey("locktotal")) {
					/* 锁定请求/分 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Lock Requests/sec") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
					...
					/* 锁定等待/分 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Lock Waits/sec") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
						if (lockWaits == 0.0D) {
					...
					/* 锁定超时/分 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Lock Timeouts/sec") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
					...
					/* 死锁数/分 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Number of Deadlocks/sec") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						deadLocks = tmpDouble;
						if (totalLogouts == 0.0D) {
							totalLogouts = new Double(tmpResult[i][3]).doubleValue();
					...
					/* 平均锁定等待时间 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Average Wait Time (ms)") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
				...
				if (gatherHash.containsKey("cache")) {
					/* 缓存击中率 */
					if (tmpResult[i][1].trim().equalsIgnoreCase("Cache Hit Ratio") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						cacheHitRatio = formatDouble(tmpDouble * 100D);
					}

					/* 缓存数 */
					if (tmpResult[i][1].trim().equalsIgnoreCase("Cache Object Counts") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
					...
					/* 使用的缓存/秒 */
					tmpDouble = 0;
					if (tmpResult[i][1].trim().equalsIgnoreCase("Cache Use Counts/sec") && tmpResult[i][2].trim().equalsIgnoreCase("_Total")) {
						tmpDouble = new Double(tmpResult[i][3]).doubleValue();
						cacheUsed = tmpDouble;
						if (cacheUsed == 0.0D) {
		...
		if (cacheHitRatio == 0.0D) {
			...
			queryStr = "select counter_name ,sum(cntr_value) from sysperfinfo " + "where object_name in ('SQLServer:Locks','SQLServer:Cache Manager') " + "and instance_name!='_Total' group by counter_name";
			try {
				util = new JdbcUtil(dburl, username, password);
	...
	public Hashtable getSqlServerData(String ip, String username, String password, Hashtable gatherHash) throws Exception {
		...
		try {
			...
			if (gatherHash.containsKey("process")) {
				// 获取SQLSERVER进程信息
				sql = "select distinct a.spid,a.waittime,a.lastwaittype,a.waitresource,b.name as dbname,c.name as " + "username,a.cpu,a.physical_io,a.memusage,a.login_time,a.last_batch,a.status,a.hostname,"
						+ "a.program_name,a.hostprocess,a.cmd,a.nt_domain,a.nt_username,a.net_library,a.loginame from " + "sysprocesses a,sysdatabases b,sysusers c where a.dbid= b.dbid and a.uid=c.uid";
				try {
					rs = util.stmt.executeQuery(sql);
					ResultSetMetaData rsmd = rs.getMetaData();
	...
	public Hashtable getMYSQLData(String ip,String port, String username, String password, String db, Hashtable gatherhash) throws Exception {
		...
		Vector Val = new Vector();
		String dburl = "jdbc:mysql://" + ip + ":"+port+"/" + db + "?user=" + username + "&password=" + password + "&useUnicode=true&&characterEncoding=gbk&autoReconnect = true";
	 ...
	 * @throws Exception
	 */
	public boolean getMySqlIsOk(String ip,String port, String username, String password, String db) throws Exception {
		String dburl = "jdbc:mysql://" + ip + ":"+port+"/" + db + "?user=" + username + "&password=" + password + "&useUnicode=true&&characterEncoding=gbk&autoReconnect = true";
		String sql = "show variables;";
		MySqlJdbcUtil util = null;
		ResultSet rs = null;
	...
	public boolean getInformixIsOk(String ip, String port, String username, String password, String db, String server) throws Exception {
		String dburl = "jdbc:informix-sqli://" + ip + ":" + port + "/" + db + ":INFORMIXSERVER=" + server + ";user=" + username + ";password=" + password; // myDB为数据库名
	 ...
	 * @throws Exception
	 */
	public Hashtable getInformixDBConfig(String ip, String port, String username, String password, String db, String server) throws Exception {
		...
		String gls = "";// 是否启动gls
		Hashtable returnVal = new Hashtable();
		String dburl = "jdbc:informix-sqli://" + ip + ":" + port + "/" + "sysmaster" + ":INFORMIXSERVER=" + server + "; user=" + username + ";password=" + password; // myDB为数据库名
		...
		try {
			...
			while (rs.next()) {
				...
				if (names.get(name) == null) {
					...
					informixspaces.put("pages_size", String.valueOf(p_size / 1024));// 空间大小
					...
					informixspaces.put("pages_free", String.valueOf(p_free / 1024));// 空闲空间
			...
			while (rs.next()) {
				...
				informixconfig.put("cf_original", rs.getString("cf_original").trim());// 引导时onconfig文件中的值
				informixconfig.put("cf_effective", rs.getString("cf_effective").trim());// 当前正在使用的值
				informixconfig.put("cf_default", rs.getString("cf_default").trim());// 如果onconfig文件没有指定值，数据库服务所提供的值
	...
	public Hashtable getInformixDBConfig(String dbid, String ip, String port, String username, String password, String db, String server, Hashtable gatherHash) throws Exception {
		String dbname = db; // 数据库名称
		String dbserver = server;// 对应的服务名称
		String createuser = "";// 创建者
		String createtime = "";// 创建时间
	...
	public boolean updateInformixOffset(String dbnodeid, String lastoffset) throws Exception {
		...
		try {
			...
			if (rs != null && rs.next()) {
				...
				// 不存在,需要添加进去
				rs.close();
				sql = "insert into nms_informixoffset(dbnodeid,lastoffset) " + "values('" + dbnodeid + "','" + lastoffset + "')";
				dbmanager.executeUpdate(sql);
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			if (gatherHash.containsKey("user")) {
				...
				try {
					...
					while (rs.next()) {
						...
						if (loginname != null && loginname.trim().length() > 0 && !"NULL".equalsIgnoreCase(loginname))
							usedconn = usedconn + 1;
					}
				} catch (Exception e) {
					e.printStackTrace();
			...
			try {
				...
				while (rs.next()) {
					...
					tvo.setStatus(rs.getString("status"));
					if ("-32768".equalsIgnoreCase(tvo.getStatus()) || "64".equalsIgnoreCase(tvo.getStatus()) || "256".equalsIgnoreCase(tvo.getStatus()) || "32".equalsIgnoreCase(tvo.getStatus()) || "320".equalsIgnoreCase(tvo.getStatus())
		...
		try {
					...
					for (OracleTopSqlSort oracleTopSqlSort : oracleTopSqlSortVector) {
						if (oracleTopSqlSort != null) {
							...
							if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
								...
								sql.append("',");
								sql.append("to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS')");
								sql.append(")");
							}
							dbManager.addBatch(sql.toString());
						}
			...
			if (sysValueHash != null && !sysValueHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					sql = "insert into nms_orasys(serverip,INSTANCE_NAME,HOST_NAME,DBNAME,VERSION,STARTUP_TIME,status,ARCHIVER,BANNER,java_pool,mon_time) " + "values('" + serverip + "','" + INSTANCE_NAME + "','" + INSTANCE_NAME + "','"
							+ DBNAME + "','" + VERSION + "','" + STARTUP_TIME + "','" + STATUS + "','" + ARCHIVER + "','" + "" + "','" + java_pool;
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						sql = sql + "','" + montime + "')";
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (memPerfValueHash != null && !memPerfValueHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					sql = "insert into nms_oramemperfvalue(serverip, pctmemorysorts, pctbufgets, dictionarycache, buffercache, librarycache,mon_time) " + "values('" + serverip + "','" + pctmemorysorts + "','" + pctbufgets + "','"
							+ dictionarycache + "','" + buffercache + "','" + librarycache;
			...
			if (cursorsHash != null && !cursorsHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					sql = "insert into nms_oracursors(serverip, opencur, curconnect,mon_time) " + "values('" + serverip + "','" + opencur + "','" + curconnect;
			...
			if (tableinfoHash != null && !tableinfoHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_oraspaces where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					...
					for (int k = 0; k < tableinfo.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_oraspaces(serverip,tablespace,free_mb,size_mb,percent_free,file_name,status,chunks,mon_time) " + "values('" + serverip + "','" + tablespace + "','" + free_mb + "','" + size_mb + "','"
								+ percent_free + "','" + file_name + "','" + status + "','" + chunks;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (rollbackinfo_vHash != null && !rollbackinfo_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_orarollback where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					...
					for (int k = 0; k < rollbackinfo_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_orarollback(serverip,rollback,wraps,shrink,ashrink,extend,mon_time) " + "values('" + serverip + "','" + rollback + "','" + wraps + "','" + shrink + "','" + ashrink + "','" + extend;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (jobhash != null && !jobhash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_orajob where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					...
					for (int k = 0; k < job_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_orajob(serverip,job,loguser,lastdate,failures,mon_time) " + "values('" + serverip + "','" + job;
			...
			if (lockinfo_vHash != null && !lockinfo_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_oralock where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					...
					for (int k = 0; k < lockinfo_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_oralock(serverip,username,status,machine,sessiontype,logontime,program,locktype,lmode,requeststr,mon_time) " + "values('" + serverip + "','" + usernames + "','" + status + "','" + machine
								+ "','" + sessiontype + "','" + logontime + "','" + program + "','" + locktype + "','" + lmode + "','" + requeststr;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
			...
			if (table_vHash != null && !table_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_oratables where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					...
					for (int k = 0; k < table_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_oratables(serverip,segment_name,spaces,mon_time) " + "values('" + serverip + "','" + segment_name + "','" + spaces;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (sql_vHash != null && !sql_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_oratopsql where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					...
					for (int k = 0; k < sql_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_oratopsql(serverip,sql_text,pct_bufgets,username,mon_time) " + "values('" + serverip;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',\"" + sql_text + "\",'" + pct_bufgets + "','" + usernames;
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + sql_text + "','" + pct_bufgets + "','" + usernames;
						}
			...
			if (contrFile_vHash != null && !contrFile_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					deletesql = "delete from nms_oracontrfile where serverip='" + serverip + "'";
					dbManager.addBatch(deletesql);
					for (int k = 0; k < contrFile_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_oracontrfile(serverip,status,name,is_recovery_dest_file,block_size,file_size_blks,mon_time) " + "values('" + serverip + "','" + status + "','" + name + "','" + is_recovery_dest_file + "','"
								+ block_size + "','" + file_size_blks;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
			...
			if (isArchive_hHash != null && !isArchive_hHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					Date createdDate = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss").parse(created);
					created = sdf.format(createdDate);
					sql = "insert into nms_oraisarchive(serverip,created,log_mode,mon_time) " + "values('" + serverip + "','" + created + "','" + log_mode;
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						sql = sql + "','" + montime + "')";
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (lstrnStatuHash != null && !lstrnStatuHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					dbManager.addBatch(deletesql);
					sql = "insert into nms_orastatus(serverip, lstrnstatu, status,mon_time) " + "values('" + serverip + "','" + lstrnStatu + "','" + status;
					if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
						sql = sql + "','" + montime + "')";
					} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
						sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (extent_vHash != null && !extent_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					for (int k = 0; k < extent_v.size(); k++) {
						...
						sql = "insert into nms_oraextent(serverip,tablespace_name,extents,mon_time) " + "values('" + serverip + "','" + tablespace_name + "','" + extents;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (logFile_vHash != null && !logFile_vHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					for (int k = 0; k < logFile_v.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_oralogfile(serverip,groupstr,status,type,member,mon_time) " + "values('" + serverip + "','" + group + "','" + status + "','" + type + "','" + member;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (waitHash != null && !waitHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					for (int k = 0; k < wait.size(); k++) {
						...
						sql = "";
						sql = "insert into nms_orawait(serverip,event,prev,curr,tot,mon_time) " + "values('" + serverip + "','" + event + "','" + prev + "','" + curr + "','" + tot;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
			...
			if (tableinfoHash != null && !tableinfoHash.isEmpty()) {
				...
				while (ipidIterator.hasNext()) {
					...
					for (int i = 0; i < tableinfo.size(); i++) {
						...
						sql = "insert into nms_oradbio(serverip, name, filename, pyr, pbr, pyw, pbw,mon_time) " + "values('" + serverip + "','" + name + "','" + filename + "','" + pyr + "','" + pbr + "','" + pyw + "','" + pbw;
						if ("mysql".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "','" + montime + "')";
						} else if ("oracle".equalsIgnoreCase(SystemConstant.DBType)) {
							sql = sql + "',to_date('" + montime + "','YYYY-MM-DD HH24:MI:SS'))";
	...
	public boolean addOracleRac(Hashtable returnhash) throws Exception {
			...
			try {
				...
				if (racstatusVector != null && racstatusVector.size() > 0) {
					...
					for (int i = 0; i < racstatusVector.size(); i++) {
						...
						String sql = "";
						try {
							sql = "insert into nms_oracle_racstatus(name,ipaddress,type,target,state,collecttime) " + "values('" + vo.getName() + "','" + vo.getIpaddress() + "','" + vo.getType() + "','" + vo.getTarget() + "','"
									+ vo.getState() + "','" + vo.getCollecttime() + "')";
		...
		if (returnhash.containsKey("raclistenerstatus")) {
			...
			String sql = "";
			try {
				sql = "insert into nms_oracle_raclistenerstatus(ipaddress,listenerstatus,listenerstatusrun,listenerstatusnode,collecttime) " + "values('" + vo.getIpaddress() + "','" + vo.getListenerstatus() + "','"
						+ vo.getListenerstatusrun() + "','" + vo.getListenerstatusnode() + "','" + vo.getCollecttime() + "')";
		...
		if (returnhash.containsKey("raccrstatus")) {
			...
			String sql = "";
			try {
				sql = "insert into nms_oracle_raccrstatus(ipaddress,raccrstatus,collecttime) " + "values('" + vo.getIpaddress() + "','" + vo.getRaccrstatus() + "','" + vo.getCollecttime() + "')";
			...
			try {
				...
				if (racstatusVector != null && racstatusVector.size() > 0) {
					...
					for (int i = 0; i < racstatusVector.size(); i++) {
						...
						String sql = "";
						try {
							sql = "insert into nms_oracle_raccrstatusdata(ipaddress,numNo,name,status,collecttime) " + "values('" + vo.getIpaddress() + "','" + vo.getNumNo() + "','" + vo.getName() + "','" + vo.getStatus() + "','"
									+ vo.getCollecttime() + "')";
	...
	public Hashtable getOracle_racstatus(String serverip) throws Exception {
		...
		Hashtable returnHash = new Hashtable();
		String sql = "select * from nms_oracle_racstatus where ipaddress = '" + serverip + "'";
		...
		sql = "select * from nms_oracle_raclistenerstatus where ipaddress = '" + serverip + "'";
		...
		sql = "select * from nms_oracle_raccrstatus where ipaddress = '" + serverip + "'";
	...
	public Vector getOracle_nmsoradiskdata(String serverip) throws Exception {
		String slq = "select * from nms_oradisk where serverip = '" + serverip + "'";
		Vector retValue = new Vector();
		DBManager dbmanager = new DBManager();
		try {
			rs = dbmanager.executeQuery(slq);
	...
	public Vector getOracle_nmsoraasmclient(String serverip) throws Exception {
		String slq = "select * from nms_oraasmclient where serverip = '" + serverip + "'";
		Vector retValue = new Vector();
		DBManager dbmanager = new DBManager();
		try {
			rs = dbmanager.executeQuery(slq);
	...
	public Vector getOracle_nmsoraasmdiskgroup(String serverip) throws Exception {
		String slq = "select * from nms_oraasmdiskgroup where serverip = '" + serverip + "'";
		Vector retValue = new Vector();
		DBManager dbmanager = new DBManager();
		try {
			rs = dbmanager.executeQuery(slq);
	...
	public Vector getOracle_nmsorabackup(String serverip) throws Exception {
		String slq = "select * from nms_orabackup where serverip = '" + serverip + "' ORDER BY START_TIME DESC";
		Vector retValue = new Vector();
		DBManager dbmanager = new DBManager();
		try {
			rs = dbmanager.executeQuery(slq);
