...
public class CompReportHelper {
	...
	public static void createPie(Vector vector) {
		...
		JFreeChart chart = ChartFactory.createPieChart("策略合规性汇总", dataset, true, false, false);
		FileOutputStream fos = null;
		try {
			fos = new FileOutputStream(ResourceCenter.getInstance().getSysPath() + "/resource/image/jfreechart/allDevice.png");
