...
public class HttpClientJBoss {
	...
	public static String getGetResponseWithHttpClient(String url, String encode) {
		...
		try {
			...
			result = HttpClientJBoss.ConverterStringCode(resultBuffer.toString(), get.getResponseCharSet(), encode);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static String getPostResponseWithHttpClient(String url, String encode) {
		...
		try {
			...
			in.close();
			result = HttpClientJBoss.ConverterStringCode(resultBuffer.toString(), post.getResponseCharSet(), encode);
		} catch (Exception e) {
			e.printStackTrace();
