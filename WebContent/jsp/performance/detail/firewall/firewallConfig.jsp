...
<script src="js/firewallConfig.js" type="text/javascript"></script>
		...
		<div id="configDiv">
			<table cellpadding="0" cellspacing="0" class="l-table-edit" id="configTable">
				<tbody>
					...
					<tr>
						<td class="l-table-edit-td">设备位置:</td>
						<td class="l-table-value-td" id="location" style="padding-left: 15px;"></td>
					</tr>
					<tr>
						<td class="l-table-edit-td">MAC地址:</td>
						<td class="l-table-value-td" id="mac" style="padding-left: 15px;"></td>
					</tr>
					<tr>
						<td class="l-table-edit-td">设备OID:</td>
						<td class="l-table-value-td" id="oid" style="padding-left: 15px;"></td>
					</tr>
					<tr>
	...
	<div id="lineTwo">
		<div id="flexDiv">
			<table style="width: 100%">
				<tbody>
					<tr>
						<td><div id="keyPort" class="flex"></div></td>
						<td><div>
								<div id="op" style="text-align: center; width: 100%; height: 25px; line-height: 25px;">
									<input name="selectIfType" type="radio" value="In" checked />入口 <input name="selectIfType" type="radio" value="Out" />出口
								</div>
								<div style="width: 100%">
									<div id="topNFlux" class="flex"></div>
									<div id="topNBandWidth" class="flex"></div>
								</div>
							</div></td>
					</tr>
				</tbody>
