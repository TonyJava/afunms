...
<%@page import="com.afunms.common.util.SessionConstant,com.afunms.system.model.User,com.afunms.realtime.DataPacketControler;"%>
<%
...
<script type='text/javascript' src='<%=basePath%>/dwr/interface/DataPacketControler.js'></script>
...
<script src="js/ifRealTimeBroadcastPkts.js" type="text/javascript"></script>
<title>实时广播</title>
<style type="text/css">
.l-table-edit-td {
	padding: 4px;
