...
<%@page import="com.afunms.common.util.SessionConstant,com.afunms.system.model.User,com.afunms.realtime.MulticastPacketControler;"%>
<%
...
<script type='text/javascript' src='<%=basePath%>/dwr/interface/MulticastPacketControler.js'></script>
...
<script src="js/ifRealTimeMulticastPkts.js" type="text/javascript"></script>
<title>实时多播</title>
<style type="text/css">
.l-table-edit-td {
	padding: 4px;
