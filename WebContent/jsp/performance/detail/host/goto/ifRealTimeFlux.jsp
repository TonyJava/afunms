...
<%@page import="com.afunms.common.util.SessionConstant,com.afunms.system.model.User,com.afunms.realtime.PortControler;"%>
<%
...
<script type='text/javascript' src='<%=basePath%>/dwr/interface/PortControler.js'></script>
...
<script src="js/ifRealTimeFlux.js" type="text/javascript"></script>
<title>实时流速</title>
<style type="text/css">
.l-table-edit-td {
	padding: 4px;
