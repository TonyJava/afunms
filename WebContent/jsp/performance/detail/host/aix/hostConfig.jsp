...
<body>
	...
	<div class="divHead">CPU配置信息</div>
	<div id="cpuConfigGrid"></div>
	<div class="divHead">内存配置信息</div>
	<div id="memoryConfigGrid"></div>
	<div class="divHead">网卡信息</div>
	<div id="netmediaConfigGrid"></div>
	<div class="divHead">用户信息</div>
	<div id="userConfigGrid"></div>
