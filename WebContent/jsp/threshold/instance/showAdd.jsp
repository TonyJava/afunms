...
<script src="js/thresholdShowAdd.js" type="text/javascript"></script>
...
<body>
	...
	<div>
		<div class="groupTitle">阈值参数</div>
		<div style="margin: 4px; float: left;">
			<div id="waitAddThresHolds"></div>
		</div>
		<div style="margin: 4px; float: left;" class="middle">
			<input type="button" onclick="moveThresHoldsToLeft()" value="&lt;" /> <input type="button" onclick="moveThresHoldsToRight()" value="&gt;" /> <input type="button"
				onclick="moveAllThresHoldsToLeft()" value="&lt;&lt;" /> <input type="button" onclick="moveAllThresHoldsToRight()" value="&gt;&gt;" />
		</div>
		<div style="margin: 4px; float: left;">
			<div id="hasAddThresHolds"></div>
		</div>
	</div>
