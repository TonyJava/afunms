...
<script src="js/tableSpaceThresHoldList.js"></script>
<script src="<%=basePath%>jsp/js/commonMethod.js"></script>
<style type="text/css">
#searchbar,#tableSpaceThresHoldGrid,#titleDiv,#textDiv {
	float: left;
}
...
<body>
	...
	<div style="width: 100%; margin-top: 2px">
		<div id="searchbar">
			<div id="titleDiv">关键字(实例名或IP):</div>
			<div id="textDiv">
				<input id="key" type="text" />
			</div>
		</div>
		<div id="tableSpaceThresHoldGrid"></div>
	</div>
</body>