...
function rendererToAlias(value, p, record) {
	...
	if (typeString.indexOf("windows") > -1) {
		...
		return "<a href='/afunms/jsp/performance/detail/mysqlPerformanceDetail.jsp?nodeId="
				+ record.data.nodeId
				+ "&alias="
				+ record.data.alias
				+ "&ip="
		...
		return "<a href='/afunms/jsp/performance/detail/oraclePerformanceDetail.jsp?nodeId="
				+ record.data.nodeId
				+ "&alias="
				+ record.data.alias
				+ "&ip="
