...
<script src="js/roleAdd.js" type="text/javascript"></script>
<style type="text/css">
.l-table-edit-td {
	padding: 4px;
}
...
<body>
	...
	<form name="roleAdd" method="post" id="roleAdd">
		<div>
			<div class="groupTitle">角色信息</div>
			<div>
				<table cellpadding="0" cellspacing="0" class="l-table-edit">
					<tr>
						<td class="l-table-label-td">角色名:</td>
						<td class="l-table-edit-td"><input name="role" type="text" id="role" ltype="text" /></td>
					</tr>
				</table>
			</div>
		</div>
