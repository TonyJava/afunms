...
<script src="js/trapList.js"></script>
	...
	<form>
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left"></td>
				<td align="right" class="l-table-edit-td">Trap信息:</td>
				<td align="left" class="l-table-edit-td"><input name="content" type="text" id="content" value="" ltype="text" /></td>
				<td><input type="button" value="确定" id="submit" class="l-button l-button-submit" /></td>
			</tr>
		</table>
	</form>
	<div id="trapGrid"></div>
