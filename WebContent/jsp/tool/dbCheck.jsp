...
<script src="js/dbCheck.js" type="text/javascript"></script>
...
<body>
	...
	<input id="dbTypeInt" type="hidden" value="<%=vo.getDbtype()%>" />
	<div id="parentDiv">
		<div class="op">
			<div>
				<div class="title" style="width: 80px">数据库类型:</div>
				<div class="inputDiv">
					<input type="text" id="dbType" value="" />
				</div>
			</div>
			<div>
		...
		<div class="op">
			<div>
				<div class="title" style="width: 80px">实例、库名:</div>
				<div class="inputDiv">
					<input type="text" id="iOrn" value="<%=vo.getDbName()%>" />
				</div>
			</div>
			<div>
