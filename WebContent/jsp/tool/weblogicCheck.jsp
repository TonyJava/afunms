...
<%
	...
	String weblogicId = (String) request.getParameter("weblogicId");
	WeblogicConfigDao dao = new WeblogicConfigDao();
	WeblogicConfig vo = new WeblogicConfig();
	try {
		if (null != weblogicId) {
			vo = (WeblogicConfig) dao.findByID(weblogicId);
		}
	} catch (Exception e) {
		e.printStackTrace();
	} finally {
...
<script src="js/weblogicCheck.js" type="text/javascript"></script>
...
<body>
	...
	<input id="versionValue" type="hidden" value="1" />
	<div id="parentDiv">
		<div class="op">
			<div>
			...
			<div>
				...
				<div class="inputDiv">
					<input type="text" id="port" value="<%=vo.getPortnum()%>" />
				</div>
			</div>
			<div>
