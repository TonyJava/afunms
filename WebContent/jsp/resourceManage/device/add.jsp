...
<script src="js/deviceAdd.js" type="text/javascript"></script>
<style type="text/css">
.l-table-edit-td {
	padding: 4px;
}
		...
		<div id="snmpPanel">
			...
			<div>
				<table cellpadding="0" cellspacing="0" class="l-table-edit">
					...
					<tr>
						<td class="l-table-label-td">读团体:</td>
						<td class="l-table-edit-td"><input name="communityRO" type="text" id="communityRO" ltype="text" /></td>
						<td class="l-table-label-td">写团体名:</td>
						<td class="l-table-edit-td"><input name="communityRW" type="text" id="communityRW" ltype="text" /></td>
					</tr>
				</table>
			</div>
		</div>
		<div>
			<div class="groupTitle">设备参数</div>
			<div>
				<table cellpadding="0" cellspacing="0" class="l-table-edit">
					<tr>
						<td class="l-table-label-td">类型:</td>
						<td class="l-table-edit-td"><select name="type" id="type" ltype="select">
						</select></td>
						<td class="l-table-label-td">子类型:</td>
						<td class="l-table-edit-td"><select name="subType" id="subType" ltype="select">
						</select></td>
					</tr>
				</table>
			</div>
