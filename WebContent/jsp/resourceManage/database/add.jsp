...
<script src="js/dbAdd.js" type="text/javascript"></script>
<style type="text/css">
.l-table-edit-td {
	padding: 4px;
}
...
<body>
			...
			<div>
				<table cellpadding="0" cellspacing="0" class="l-table-edit">
					<tr>
						...
						<td class="l-table-edit-td"><select name="dbtype" id="dbtype" ltype="select">
						</select></td>
						<td class="l-table-label-td" id="db_name">名称:</td>
	...
	<div class="btDiv">
		<input type="submit" value="提交" id="submit" class="l-button" /> <input type="button" value="关闭" id="closeWindow" class="l-button" />
	</div>
</html>