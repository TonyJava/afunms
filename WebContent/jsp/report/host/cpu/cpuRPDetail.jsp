...
<script src="js/cpuRPDetail.js"></script>
	...
	<form>
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="endDate" type="text" id="endDate" value="<%=endDate + " 23:59:59" %>" readonly="readonly" /></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
	<div id="cpuDetailGrid"></div>
</body>
</html>