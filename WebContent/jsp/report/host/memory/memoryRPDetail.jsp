...
<script src="js/memoryRPDetail.js"></script>
	...
	<form>
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="startDate" type="text" id="startDate" value="<%=startDate + " 00:00:00" %>" readonly="readonly" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td">结束时间:</td>
				<td align="left" class="l-table-edit-td"><input name="endDate" type="text" id="endDate" value="<%=endDate + " 23:59:59:59" %>" readonly="readonly" /></td>
				<td align="left"></td>
			</tr>
		</table>
	</form>
	<div id="memoryDetailGrid"></div>
</body>
</html>