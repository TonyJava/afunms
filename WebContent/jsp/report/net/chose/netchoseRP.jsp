...
<script src="js/netchoseRP.js"></script>
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="startDate"
					type="text" id="startDate" value="<%=startDate %>" ltype="date" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td">结束日期:</td>
				<td align="left" class="l-table-edit-td"><input name="endDate"
					type="text" id="endDate" value="<%=endDate %>" ltype="date"  /></td>
				<td align="left"></td>
				<td align="left" class="l-table-edit-td"><input name="content"
					type="text" id="content" value="" ltype="text"  /></td>
				<td><input type="button" value="确定" id="bt" class="l-button l-button-submit" /> </td>
			</tr>
		</table>
	</form>
	<div id="netchoseGrid"></div>
</body>
</html>