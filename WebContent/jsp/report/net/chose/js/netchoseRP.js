...
function f_getNodeList() {
	...
	$.ajax({
				...
				async : false,
				url : basePath
						+ "netReportAjaxManager.ajax?action=netchoceList",
				data : {
					content : $("#content").val()
				},
				dataType : "json",
...
function exportNetChoceReport(ids){
	...
	$.ajax({
				...
				async : false,
				url : basePath
						+ "netReportAjaxManager.ajax?action=exportNetChoceReport",
				// 参数
				data : {
					ids : ids,
