...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	Node node = (Node) PollingEngine.getInstance().getTomcatByIP((String)request.getParameter("ip"));
...
$(function() {
	...
	$("#title").text("<%=alias%>("+ip+")");
	var so = new SWFObject("<%=basePath%>flex/Tomcat_JVM_Memory_month.swf?ipadress=" + ip + "&id=" + id, "Tomcat_JVM_Memory_month", "800", "250", "8", "#ffffff");
