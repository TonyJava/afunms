...
<%@page import="com.afunms.alarm.model.IndicatorsTopoRelation"%>
...
<%
  ...
  System.out.println("------------>nodeid+type+subtype:"+nodeid+":"+type+":"+subtype);
%>
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 资源 >> 性能配置 >> 快捷指标列表 </td>
															...
															<table>
							        							...
							        							<%
							        								...
							        								if(list != null && list.size() > 0) {
							        									...
							        									IndicatorsTopoRelation alarmRelation =null;
							        									for(int i = 0; i < list.size(); i++){
							        										alarmRelation = (IndicatorsTopoRelation)list.get(i);
																			if(moidHash.containsKey(alarmRelation.getIndicatorsId())){
																				alarmIndicatorsNode = (AlarmIndicatorsNode)moidHash.get(alarmRelation.getIndicatorsId());
																				if(alarmIndicatorsNode == null)continue;
																			}
							        										...
							        										<tr <%=onmouseoverstyle%>>
																    			...
																    			<td class="body-data-list"><%=alarmIndicatorsNode.getDescr()%></td>
										        							</tr>
							        										<%
							        									}
							        								}%>
