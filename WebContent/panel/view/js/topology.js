...
{	
	...
	for (var i = 0; i < nodes.length; i += 1)
	{
		...
		var imgValue = "../../panel/view/"+ node.getElementsByTagName("img")[0].text;
		//var imgValue = "../../panel/view/image/up_green.gif";
		//alert(imgValue);
	...
	if (eventX > 0 & eventY > 0 & eventX < window.screen.width & eventY < window.screen.height)
	{
		if(obj != null)
		{
			...
			else
			{
				...
				obj.style.top = tempY;
				textStyle.left = tempX - 10;
				textStyle.top = tempY + 20;
