...
<%
	...
	List<com.afunms.emc.model.Disk> disk = (List<com.afunms.emc.model.Disk>) request.getAttribute("disk");
															...
															<tr>
												      		   <td valign=top align="left">
																			 <div class="limitWidth">
	                                                                              ...
	                                                                              <ul class="sideNav" >
	                                                                                   <%
								                                      com.afunms.emc.model.Disk vo1 = null;
								                                      if(disk!= null && disk.size()>0){
								                                        for(int i=0;i<disk.size();i++){
								                                          vo1 = (com.afunms.emc.model.Disk)disk.get(i);
												             ...
												             <tr>
												              <td>
												                ...
												                <table cellspacing="0" cellpadding="0" width="width:100%" bgcolor="#FFFFFF" border=1  class="detail-data-body">
								                                    ...
								                                    <%
								                                     com.afunms.emc.model. Disk vo = null;
								                                      if(disk!= null && disk.size()>0){
								                                      int h=0;
								                                        for(int i=0;i<disk.size();i++){
								                                          vo = (com.afunms.emc.model.Disk)disk.get(i);
