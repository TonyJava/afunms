			...
			<tr style="background-color: #ECECEC;">
				...
				<TD nowrap width="40%">&nbsp;
					<select id="version" name="version">
						<option value="5" <%if("5".equals(vo.getVersion())){ %>selected<%} %>>V5</option>
						<option value="6" <%if("6".equals(vo.getVersion())){ %>selected<%} %>>V6</option>
						<option value="7" <%if("7".equals(vo.getVersion())){ %>selected<%} %>>V7</option>
						<option value="8" <%if("8".equals(vo.getVersion())){ %>selected<%} %>>V8</option>
					</select>
					<font color='red'>*</font>
				</TD>
			</tr>
